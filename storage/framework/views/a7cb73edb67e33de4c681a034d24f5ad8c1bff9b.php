        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"><?php echo e(__('All Menus')); ?> </h5>
                    <div>
                        <div class="widgetbar">
                            <a href="<?php echo e(url('admin/menu/create')); ?>" class="float-right btn btn-primary-rgba mr-2" title="<?php echo e(__('Add Menu')); ?>"><i
                                    class="feather icon-plus mr-2"></i><?php echo e(__('Add Menu')); ?> </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                <a class="dropdown-item"
                                                    href="<?php echo e(url('admin/menu/'.$policy->id.'/edit')); ?>" title="<?php echo e(__('Edit')); ?>"><i
                                                        class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                                <a class="dropdown-item btn btn-link" data-toggle="modal"
                                                    data-target="#delete<?php echo e($policy->id); ?>" title="<?php echo e(__('Delete')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/admin/menu/index.blade.php ENDPATH**/ ?>