              ...
              <div class="card-header">
                  ...
                  <div>
                    <div class="widgetbar">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('batch.delete')): ?>
                        <a href="page-product-detail.html" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target=".bd-example-modal-sm1" title="<?php echo e(__('Delete Selected')); ?>"><i class="feather icon-trash mr-2"></i><?php echo e(__('Delete Selected')); ?></a>
                        <?php endif; ?>                     
                     ...
                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('batch.create')): ?>
                        <a href="<?php echo e(route('batch.create')); ?>"  class="btn btn-primary-rgba mr-2" title="<?php echo e(__('Add Batch')); ?>"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add Batch')); ?></a>
                        <?php endif; ?>                   
                </div>
                </div>
              </div>
                  ...
                  <div class="table-responsive">
                      <table id="datatable-buttons" class="table table-striped table-bordered">
                          ...
                          <label for="checkboxAll" class="material-checkbox"></label>#</th>
                            ...
                            <th><?php echo e(__('Batch Name')); ?></th>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php if($cat['preview_image'] !== NULL && $cat['preview_image'] !== ''): ?>
                                        <img src="images/batch/<?php echo $cat['preview_image'];  ?>" class="img-circle" alt="<?php echo e($cat->title); ?>">
                                    <?php else: ?>
                                        <img src="<?php echo e(Avatar::create($cat->title)->toBase64()); ?>" class="img-circle" alt="<?php echo e($cat->title); ?>">
                                    <?php endif; ?>
                                  </td>
                                  ...
                                  <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <a class="dropdown-item" href="<?php echo e(route('batch.show',$cat->id)); ?>" title="<?php echo e(__('Edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                              ...
                              <?php $__currentLoopData = $cors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                  ...
                                  <div class="dropdown">
                                      <button class="btn btn-round btn-outline-primary" type="button" id="CustomdropdownMenuButton1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo e(__('Settings')); ?>"><i class="feather icon-more-vertical-"></i></button>
                                      <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('batch.edit')): ?>
                                          <a class="dropdown-item" href="<?php echo e(route('bundle.show',$cor->id)); ?>" title="<?php echo e(__('Edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                          <?php endif; ?>
                                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('batch.delete')): ?>
                                          <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete<?php echo e($cor->id); ?>" title="<?php echo e(__('Delete')); ?>">
                                              <i class="feather icon-delete mr-2"></i><?php echo e(__("Delete")); ?></a>
                                          </a>
                                          <?php endif; ?>
                                      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/admin/batch/index.blade.php ENDPATH**/ ?>