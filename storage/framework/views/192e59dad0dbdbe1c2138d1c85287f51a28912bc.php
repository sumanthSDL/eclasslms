...
<?php $__env->startSection('title', 'Breadcum - Setting'); ?>
        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <h5 class="card-title"><?php echo e(__('Breadcum')); ?></h5>
                </div>
                <div class="card-body">
                    <form class="form" action="<?php echo e(route('breadcum.update')); ?>" method="POST" novalidate
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <img src="<?php echo e(url('/images/breadcum/'.$setting->img)); ?>" height="100px;" width="100px;" />
                                <?php else: ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/admin/breadcum/setting.blade.php ENDPATH**/ ?>