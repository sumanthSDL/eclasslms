          ...
          <div class="card-header">
            ...
            <form autocomplete="off" action="<?php echo e(route('db.next')); ?>" id="step2form" method="POST" class="database-validation" novalidate>
              ...
              <div class="row">
                ...
                <button class="float-right step1btn btn btn-primary" type="submit">Continue</button>
              </div>
            </form>
...
<?php /**PATH C:\Users\CSC\OneDrive\Desktop\laravel\eclass-new\codecanyon-dMW2IBNl-eclass-learning-management-system\eclass\eclass\resources\views/db.blade.php ENDPATH**/ ?>