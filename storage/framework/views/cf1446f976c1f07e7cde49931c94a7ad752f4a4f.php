...
<?php $__env->startSection('title', 'Login - Setting'); ?>
        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <h5 class="card-title"><?php echo e(__('Login/Signup')); ?></h5>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/admin/setting/login.blade.php ENDPATH**/ ?>