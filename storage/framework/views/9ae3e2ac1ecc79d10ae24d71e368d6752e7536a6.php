      ...
      <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    ...
                    <div>
                      <div class="widgetbar">
                          <a href="<?php echo e(url('feature/create')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add Feature")); ?></a>
                      </div>                        
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <img src="<?php echo e(asset('images/feature/'.$data->image)); ?>" class="img-responsive img-circle" >
                                </td>
                               ...
                               <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                        <a class="dropdown-item"   href="<?php echo e(route('feature.edit',$data->id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/admin/feature/index.blade.php ENDPATH**/ ?>