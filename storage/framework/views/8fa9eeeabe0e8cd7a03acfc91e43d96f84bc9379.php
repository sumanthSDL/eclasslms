<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Allinstructor.edit')): ?>
        ...
        <?php endif; ?>
        <a class="dropdown-item" href="<?php echo e(url('instructor/skills')); ?>" title="<?php echo e(__('Add Skill')); ?>"><i
            class="feather icon-edit mr-2"></i><?php echo e(__('Add Skills')); ?></a>
    </div>
</div>
...
<!-- delete Model ended -->
<?php /**PATH C:\xampp\htdocs\eclass\eclass-licenced\resources\views/admin/allinstructor/action.blade.php ENDPATH**/ ?>