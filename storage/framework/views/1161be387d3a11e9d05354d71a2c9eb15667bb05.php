            ...
            <?php echo e(csrf_field()); ?>
                ...
                <div id="more_quiz0">
                 ...
                 <div class="row">
                  ...
                  <?php if($que[0]['data_type']=='True/False'): ?>
                  <label class="radio">
                     <input type="radio" class="q_answer" required name="answer[<?php echo e($count); ?>]" value="<?php echo e($que[0]['first_option_ans']); ?>"><?php echo e($que[0]['first_option_ans']); ?>

                  </label>
                  <label class="radio">
                     <input type="radio" class="q_answer" required name="answer[<?php echo e($count); ?>]" value="<?php echo e($que[0]['second_option_ans']); ?>"><?php echo e($que[0]['second_option_ans']); ?>
              ...
              <div class="jumbotron" id="quiz<?php echo e($key+1); ?>" >
                  ...
                  <?php if($equestion['data_type']=='True/False'): ?>
                  <label class="radio">
                     <input type="radio" class="q_answer" required name="answer[<?php echo e($count); ?>]" value="<?php echo e($equestion['first_option_ans']); ?>"><?php echo e($equestion['first_option_ans']); ?>

                  </label>
                  <label class="radio">
                     <input type="radio" class="q_answer" required name="answer[<?php echo e($count); ?>]" value="<?php echo e($equestion['second_option_ans']); ?>"><?php echo e($equestion['second_option_ans']); ?>
              ...
              <div class="col-lg-4">
                 <div class="quiz-tabs">
                      ...
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile<?php echo e($equestion->id); ?>" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__('Image')); ?></a>
                        </li>
                      ...
                      <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="profile<?php echo e($equestion->id); ?>" role="tabpanel" aria-labelledby="profile-tab">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/front/quiz/main_quiz.blade.php ENDPATH**/ ?>