...
unset($__errorArgs, $__bag); ?>" type="text" name="domain" value="<?php echo e(old('domain')); ?>" placeholder="eg:example.com"/>
					...
					<small class="text-muted">
						<i class="fa fa-question-circle"></i> <?php echo e(__('IF still facing the access denied error please contact')); ?> <a target="_blank" href="https://codecanyon.net/item/eclass-learning-management-system/25613271/support"><?php echo e(__('Support')); ?></a> <?php echo e(__('for updation in domain.')); ?>.
					</small>
...
</html><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/accessdenied.blade.php ENDPATH**/ ?>