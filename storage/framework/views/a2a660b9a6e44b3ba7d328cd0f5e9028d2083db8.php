        ...
        <div class="card-header">
          ...
          <div>
            <div class="widgetbar">
              ...
              <a href="<?php echo e(route('order.create')); ?>" class="btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Enroll User')); ?></a> title="<?php echo e(__('Enroll User')); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass-licenced\resources\views/admin/refund_order/show.blade.php ENDPATH**/ ?>