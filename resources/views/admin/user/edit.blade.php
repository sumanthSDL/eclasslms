            ...
            <div class="col-lg-12">
                <div class="card dashboard-card m-b-30">
                    <div class="card-header">
                        ...
                        <div class="widgetbar">
                            <a href="{{ route('user.index') }}" class="float-right btn btn-primary-rgba mr-2"
                                title="{{ __('Back') }}"><i
                        ...
                        <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="bg-info-rgba p-4 mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="mobile">{{ __('Email') }}:<sup class="text-danger">*</sup>
                                            </label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $user->mobile }}" type="text" name="mobile"
                                                placeholder="{{ __('Enter Mobile') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="mobile"> {{ __('Course') }}:</label>
                                            <input value="{{ $user->course }}" type="text" name="course"
                                                placeholder="{{ __('Course Name') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="mobile"> {{ __('Payment Status') }}:</label>
                                            <input value="{{ $user->payment_status }}" type="text" name="payment_status"
                                                placeholder="{{ __('Payment Status') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="detail" name="detail" class="form-control" rows="5" placeholder="{{ __('Enter Detail') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" class="form-control" rows="1" placeholder="{{ __('Enter Adderss') }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Please') }} {{ __('Enter City') }}"
                                                onchange="get_state_country(this.value)"
                                                value="{{ $cities ? $cities->name : '' }}">
                                            <input type="hidden" name="city_id" value="{{ $user->id }}"
                                                class="city_id">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control state"
                                                placeholder="{{ __('Please Enter State') }}"
                                                value="{{ $states ? $states->name : '' }}" readonly>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control country"
                                                placeholder="{{ __('Please Enter Country') }}"
                                                value="{{ $countries ? $countries->name : '' }}" readonly>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $user->pin_code }}" placeholder="{{ __('Enter Pincode') }}"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="user_img" class="custom-file-input"
                                                        id="user_img_one" aria-describedby="inputGroupFileAddon01"
