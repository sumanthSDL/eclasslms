                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                      <div class="form-group">
                                          <label class="text-dark">{{ __('PWA Icon') }} (512x512PX) : <span class="text-danger">*</span> </label>           
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          <label class="text-dark">{{ __('PWA') }} {{ __('Splash Screen') }} (2048x2732PX) : <span class="text-danger">*</span> </label>
