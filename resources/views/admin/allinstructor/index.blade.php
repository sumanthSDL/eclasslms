                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                                ...
                                title="{{ __('All Instructors') }}">{{ __('All Instructors') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
                                role="tab" aria-controls="pills-profile" aria-selected="false"
                                title="{{ __('Pending Instructors Request') }}">{{ __('Pending Instructors Request') }}</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 text-right menus-button">
                                    <a href="page-product-detail.html" class="btn btn-danger-rgba" data-toggle="modal"
                                        data-target=".bd-example-modal-sm1" title="{{ __('Delete Selected') }}"><i
                                            class="feather icon-trash mr-2"></i>{{ __('Delete Selected') }}</a>
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="post"
                                                        action="{{ action('BulkdeleteController@instructorrequestdeleteAll') }}"
                                                        id="bulk_delete_form" data-parsley-validate
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img @error('photo') is-invalid @enderror
                                                    ...
                                                    alt="{{ $item->fname }}" class="img-responsive img-circle">
                                                @else
                                                <img @error('photo') is-invalid @enderror
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-round btn-primary-rgba" type="button"
                                                        ...
                                                        title="{{ __('Settings') }}"><i class="feather icon-more-vertical-"></i></button>
                                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#instructorviewModal{{ $item->id }}"
                                                            title="{{ __('View') }}"><i
                                                                class="feather icon-delete mr-2"></i>{{ __("View") }}</a>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                ...
                                                @endphp
                                                @if(isset($show))
                                                <!-- Modal for Instructor Details View -->
                                                <div class="modal fade" id="instructorviewModal{{ $item->id }}"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">{{ __('View Instructor Details') }}</h5>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-group col-md-12">
                                                                            <div class="instructor-detail-img text-center">
                                                                                ...
                                                                                <img @error('photo') is-invalid @enderror
                                                                                    src="{{ url('images/user_img/'.$show->user_img) }}"
                                                                                    alt="{{ $show->fname }} {{ $show['lname'] }}"
                                                                                    class="img-responsive img-circle">
                                                                                @else
                                                                                <img @error('photo') is-invalid @enderror
                                                                                    src="{{ Avatar::create($show->fname)->toBase64() }}"
                                                                                    alt="{{ $show->fname }} {{ $show['lname'] }}"
                                                                                    class="img-responsive img-circle">
                                                                                @endif
                                                                            </div>
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th scope="row"
                                                                                                class="p-1"><span
                                                                                                    class="text-color">{{ __('Role') }}:</span>
                                                                                            </th>
                                                                                            <td
                                                                                                class="p-1">{{ $show->role }}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th scope="row"
                                                                                                class="p-1"><span
                                                                                                    class="text-color">{{ __('Phone') }}:</span>
                                                                                            </th>
                                                                                            <td class="p-1"><a
                                                                                                    href="tel:{{ $show->mobile }}">{{ $show->mobile }}</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th scope="row"
                                                                                                class="p-1"><span
                                                                                                    class="text-color">{{ __('Email') }}:</span>
                                                                                            </th>
                                                                                            <td class="p-1"><a
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="row"
                                                                                                class="p-1"><span
                                                                                                    class="text-color">{{ __('Detail') }}:</span>
                                                                                            </th>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="row"
                                                                                                class="p-1"><span
                                                                                                    class="text-color">{{ __('Resume') }}:</span>
                                                                                            </th>
                                                                                            <td class="p-1"><a
                                                                                                    href="{{ asset('files/instructor/'.$show->file) }}"
                                                                                                    download="{{ $show->file }}"
                                                                                                    title="{{ __('Download') }}">{{ __('Download') }} <i
                                                                            ...
                                                                            <br>
                                                                            <form
                                                                                action="{{ route('requestinstructor.update', $show->id) }}"
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <label
                                                                                            for="exampleInputTit1e">{{ __('Status') }}:</label>
                                                                                    </div>
                                                                                    <div class="col-md-8">
                                                                                        <input type="checkbox"
                                                                                            name="search_enable"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <button type="reset"
                                                                                        class="btn btn-danger-rgba mr-1"
                                                                                        title="{{ __('Reset') }}"><i
                                                ...
                                                <!-- End Modal for Instructor Details View -->
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons"
                                    ...
                                    <tbody>
                                        ...
                                        @if($item->status == '0')
                                        <tr>
                                            <td><img src="{{ asset('images/instructor/'.$item->image) }}"
                                                    class="img-circle"></td>
                                            <td>{{$item->fname}}</td>
                                            <td>{{$item->email}}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('requestinstructor.edit',$item->id) }}"><i
                                            ...
                                            <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form
                                                                action="{{ route('requestinstructor.destroy', $item->id) }}"
                                            ...
                                            <!-- End Modal for Individual Delete -->
                                        </tr>
                                        @endif
                                        @endforeach
                                    </tbody>
