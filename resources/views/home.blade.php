            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-5">
                    <div class="view-button txt-rgt">
                        <a href="{{ url('topdiscounted/view') }}" class="btn btn-secondary"
                            title="View More">{{ __('View More') }}<i data-feather="chevrons-right"></i>
                        </a>
                    </div>
                </div>
            </div>
                ...
                @foreach ($discountcourse as $discount)
                    @if ($discount->status == 1 && $discount->featured == 1)
                        <div class="item student-view-block student-view-block-1">
                                ...
                                <div class="view-block">
                                    <div class="view-img">
                                        @if ($discount['preview_image'] !== null && $discount['preview_image'] !== '')
                                            <a
                                                href="{{ route('user.course.show', ['id' => $discount->id, 'slug' => $discount->slug]) }}"><img
                                                    data-src="{{ asset('images/course/' . $discount['preview_image']) }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @else
                                            <a
                                                href="{{ route('user.course.show', ['id' => $discount->id, 'slug' => $discount->slug]) }}"><img
                                                    data-src="{{ Avatar::create($discount->title)->toBase64() }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @endif
                                    </div>
                                    <div class="badges bg-priamry offer-badge">
                                        <span>OFF<span><?php echo round((($discount->price - $discount->discount_price) * 100) / $discount->price) . '%'; ?></span></span>
                                    </div>
                                    ...
                                    <div class="view-user-img">
                                        ...
                                        @if (optional($discount->user)['user_img'] !== null && optional($discount->user)['user_img'] !== '')
                                            <a href="{{ route('all/profile', $discount->user->id) }}"
                                                title=""><img
                                                    src="{{ asset('images/user_img/' . $discount->user['user_img']) }}"
                                                    class="img-fluid user-img-one" alt=""></a>
                                        @else
                                            <a href="{{ route('all/profile', $discount->id) }}" title=""><img
                                    ...
                                    @if (isset($discount->user->id))
                                        <div class="view-dtl">
                                            ...
                                            <div class="user-name">
                                                <h6>By <span><a
                                                            href="{{ route('all/profile', $discount->user->id) }}">
                                                            {{ optional($discount->user)['fname'] }}</a></span></h6>
                                            </div>
                                            <div class="rating">
                                                <ul>
                                                    <li>
                                                            ...
                                                            <div class="rate text-right">
                                                                <ul>
                                                                    ...
                                                                    @if ($discount->discount_price == !null)
                                                                        <li><a><b>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($discount['discount_price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}
                                                ...
                                                <div class="protip-wishlist">
                                                    <ul>
                                                        ...
                                                        <li class="protip-wish-btn"><a
                                                                ...
                                                                target="__blank" title="reminder"><i
                                                                    data-feather="bell"></i></a></li>

                                                        @if (Auth::check())
                                                            <li class="protip-wish-btn"><a class="compare"
                                                                    data-id="{{ filter_var($discount->id) }}"
                                                                    title="compare"><i
                                                            ...
                                                            @else
                                                                <li class="protip-wish-btn-two">
                                                                    <form id="demo-form2" method="post"
                                                                        ...
                                                                        <button class="wishlisht-btn heart-fill"
                            ...
                            <div id="prime-next-item-description-block{{ $discount->id }}"
                                                ...
                                                <div class="col-lg-8">
                                                    @if ($discount->type == 1)
                                                        ...
                                                        @else
                                                            @if ($gsetting->guest_enable == 1)
                                                                <form id="demo-form2" method="post"
                                                                    action="{{ route('guest.addtocart', $discount->id) }}"
                                                                    data-parsley-validate
                                                                    class="form-horizontal form-label-left">
                                                                    {{ csrf_field() }}
                                                    ...
                                                    @else
                                                        ...
                                                        @else
                                                            <div class="protip-btn">
                                                                <a href="{{ route('login') }}"
                                                                    class="btn btn-primary" title="Enroll Now"><i
                                                                        data-feather="shopping-cart"></i>{{ __('Enroll Now') }}</a>
                                                            </div>
                                                        @endif
                                                    @endif
                                                                    ...
                                                                    @else
                                                                        <li class="protip-wish-btn-two">
                                                                            <form id="demo-form2" method="post"
                                                                                ...
                                                                                <button
                                                                                    class="wishlisht-btn heart-fill"
                                            ...
                                            <div class="view-block">
                                                <div class="view-img">
                                                    ...
                                                    @else
                                                        <a
                                                            href="{{ route('user.course.show', ['id' => $recent_course->id, 'slug' => $recent_course->slug]) }}"><img
                                                                data-src="{{ Avatar::create($recent_course->title)->toBase64() }}"
                                                                alt="course" class="img-fluid owl-lazy"></a>
                                                    @endif
                                                </div>
                                                ...
                                                @if ($recent_course['level_tags'] == 'intermediate')
                                                    <div class="advance-badge">
                                                        <span
                                                            class="badge bg-secondary">{{ __('Intermediate') }}</span>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="view-user-img">
                                                    ...
                                                    @if ($recent_course->user['user_img'] !== null && $recent_course->user['user_img'] !== '')
                                                        <a href="{{ route('all/profile', $recent_course->user->id) }}"
                                                            title=""><img
                                                ...
                                                <div class="view-dtl">
                                                    ...
                                                    <div class="user-name">
                                                        <h6>By <span><a
                                                                    href="{{ route('all/profile', $recent_course->user->id) }}">
                                                                    {{ optional($recent_course->user)['fname'] }}</a></span>
                                                        </h6>
                                                    </div>
                                                    <div class="rating">
                                                        <ul>
                                                        ...
                                                        <div class="protip-wishlist">
                                                            <ul>
                                                                ...
                                                                @else
                                                                    <li class="protip-wish-btn"><a
                                                                            href="{{ route('login') }}"
                                                                            title="heart"><i data-feather="heart"
                                                                                class="rgt-10"></i></a></li>
                                                                @endif
                                                            </ul>
                                                        </div>
                                        ...
                                        <div class="view-block">
                                            <div class="view-img">
                                                ...
                                                @else
                                                    <a
                                                        href="{{ route('course.content', ['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug]) }}"><img
                                                            data-src="{{ Avatar::create($enrol->courses->title)->toBase64() }}"
                                                            alt="course" class="img-fluid owl-lazy"></a>
                                                @endif
                                            </div>
                                            <div class="view-user-img">
                                                ...
                                                @if ($enrol->user['user_img'] !== null && $enrol->user['user_img'] !== '')
                                                    <a href="{{ route('all/profile', $enrol->user->id) }}"
                                                        title=""><img
                                                            src="{{ asset('images/user_img/' . $enrol->user['user_img']) }}"
                                                            class="img-fluid user-img-one" alt=""></a>
                                                @else
                                                    <a href="{{ route('all/profile', $enrol->user->id) }}"
                                                        title=""><img
                                            ...
                                            <div class="view-dtl">
                                                ...
                                                <div class="user-name">
                                                    <h6>By <span><a
                                                                href="{{ route('all/profile', $enrol->user->id) }}">
                                                                ...
                                                                <div class="rate text-right">
                                                                    <ul>
                                                                        ...
                                                                        @if ($enrol->courses->discount_price == !null)
                                                                            <li><a><b>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                @foreach ($categories as $cats)
                                    <li class="btn nav-item"><a class="nav-item nav-link" id="home-tab"
                                            data-toggle="tab" href="#content-tabs" role="tab"
                                            aria-controls="home" onclick="showtab('{{ $cats->id }}')"
                ...
                <div class="container-xl">
                    <a href="{{ $adv->url1 }}" title="{{ __('Click to visit') }}">
                        <img class="lazy img-fluid advertisement-img-one"
                            data-src="{{ url('images/advertisement/' . $adv->image1) }}"
                            alt="{{ $adv->image1 }}">
                    </a>
                </div>
            </section>
    ...
    <section id="student" class="student-main-block">
        <div class="container-xl">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-5">
                    <div class="view-button txt-rgt">
                        <a href="{{ url('featuredcourse/view') }}" class="btn btn-secondary"
                            title="View More">{{ __('View More') }}<i data-feather="chevrons-right"></i>
                        </a>
                    </div>
                </div>
                ...
                @foreach ($cors as $c)
                    @if ($c->status == 1 && $c->featured == 1)
                        <div class="item student-view-block student-view-block-1">
                                ...
                                <div class="view-block">
                                        ...
                                        @if ($c['preview_image'] !== null && $c['preview_image'] !== '')
                                            <a
                                                href="{{ route('user.course.show', ['id' => $c->id, 'slug' => $c->slug]) }}"><img
                                                    data-src="{{ asset('images/course/' . $c['preview_image']) }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @else
                                            <a
                                                href="{{ route('user.course.show', ['id' => $c->id, 'slug' => $c->slug]) }}"><img
                                                    data-src="{{ Avatar::create($c->title)->toBase64() }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @endif
                                    </div>
                                    @if (isset($c->discount_price))
                                        <div class="badges bg-priamry offer-badge">
                                            <span>OFF<span><?php echo round((($c->price - $c->discount_price) * 100) / $c->price) . '%'; ?></span></span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="view-user-img">
                                        ...
                                        @if (optional($c->user)['user_img'] !== null && optional($c->user)['user_img'] !== '')
                                            <a href="{{ route('all/profile', $c->user->id) }}" title=""><img
                                    ...
                                    <div class="view-dtl">
                                        ...
                                        <div class="user-name">
                                            <h6>By <span><a href="{{ route('all/profile', $c->user->id) }}">
                            ...
                            <div id="prime-next-item-description-block{{ $c->id }}"
                                class="prime-description-block">
                                <div class="prime-description-under-block">
                                    <div class="prime-description-under-block">
                                                ...
                                                <div class="col-lg-8">
                                                    @if ($c->type == 1)
                                                        ...
                                                        @else
                                                            @if ($gsetting->guest_enable == 1)
                                                                <form id="demo-form2" method="post"
                                                                    action="{{ route('guest.addtocart', $c->id) }}"
                                                                    data-parsley-validate
                                                                    class="form-horizontal form-label-left">
                                                                    {{ csrf_field() }}
                                    ...
                                    <div class="view-img">
                                        @if ($bundle['preview_image'] !== null && $bundle['preview_image'] !== '')
                                            <a href="{{ route('bundle.detail', $bundle->id) }}"><img
                                                    data-src="{{ asset('images/bundle/' . $bundle['preview_image']) }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @else
                                            <a href="{{ route('bundle.detail', $bundle->id) }}"><img
                                                    data-src="{{ Avatar::create($bundle->title)->toBase64() }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @endif
                                    </div>
                                    <div class="badges bg-priamry offer-badge">
                                        <span>OFF<span><?php echo round((($bundle->price - $bundle->discount_price) * 100) / $bundle->price) . '%'; ?></span></span>
                                    </div>

                                    <div class="view-user-img">

                                        @if ($bundle->user['user_img'] !== null && $bundle->user['user_img'] !== '')
                                            <a href="{{ route('all/profile', $bundle->user->id) }}"
                                                title=""><img
                                                    src="{{ asset('images/user_img/' . $bundle->user['user_img']) }}"
                                                    class="img-fluid user-img-one" alt=""></a>
                                        @else
                                            <a href="{{ route('all/profile', $bundle->user->id) }}"
                                                title=""><img src="{{ asset('images/default/user.png') }}"
                                                    class="img-fluid user-img-one" alt=""></a>
                                        @endif
                                    </div>
                                    <div class="view-dtl">
    ...
    <section id="bundle-block" class="student-main-block">
        <div class="container-xl">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-5">
                    <div class="view-button txt-rgt">
                        <a href="{{ url('bundle/view') }}" class="btn btn-secondary" title="View More">View More<i
...
@endif
                                                    ...
                                                    <ul>
                                                        ...
                                                        @if (Auth::check())
                                                            ...
                                                            @if ($wish == null)
                                                                <li class="protip-wish-btn">
                                                                    <form id="demo-form2" method="post"
                                                                        action="{{ url('show/wishlist', $bundle->id) }}"
                                                                        data-parsley-validate
                                                                        class="form-horizontal form-label-left">
                                                                        {{ csrf_field() }}
                                                            ...
                                                            @else
                                                                <li class="protip-wish-btn-two">
                                                                    <form id="demo-form2" method="post"
                                                                        action="{{ url('remove/wishlist', $bundle->id) }}"
                                                                        data-parsley-validate
                                                                        class="form-horizontal form-label-left">
                                                                        {{ csrf_field() }}
                                ...
                                <div id="prime-next-item-description-block-4{{ $bundle->id }}"
                                    class="prime-description-block">
                                    <div class="prime-description-under-block">
                                        <div class="prime-description-under-block">
                                            <h5 class="description-heading">{{ $bundle['title'] }}</h5>
    ...
    <section id="student" class="student-main-block">
        <div class="container-xl">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-5">
                    <div class="view-button txt-rgt">
                        <a href="{{ url('bestselling/view') }}" class="btn btn-secondary" title="View More">View
                            More<i data-feather="chevrons-right"></i>
                        </a>
                    </div>
                </div>
            </div>
                ...
                @foreach ($bestselling as $best)
                    ...
                    @if ($best->courses->status == 1)
                        ...
                        <div class="item student-view-block student-view-block-1">
                                ...
                                <div class="view-block">
                                        ...
                                        @if ($best->courses['preview_image'] !== null && $best->courses['preview_image'] !== '')
                                            <a
                                                href="{{ route('user.course.show', ['id' => $best->courses->id, 'slug' => $best->courses->slug]) }}"><img
                                                    data-src="{{ asset('images/course/' . $best->courses['preview_image']) }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @else
                                            <a
                                                href="{{ route('user.course.show', ['id' => $best->courses->id, 'slug' => $best->courses->slug]) }}"><img
                                                    data-src="{{ Avatar::create($best->title)->toBase64() }}"
                                                    alt="course" class="img-fluid owl-lazy"></a>
                                        @endif
                                    </div>
                                    ...
                                    <div class="view-user-img">
                                        @if ($best->courses->user['user_img'] !== null && $best->courses->user['user_img'] !== '')
                                            <a href="{{ route('all/profile', $best->courses->user->id) }}"
                                                title=""><img
                                    ...
                                    <div class="view-dtl">
                                        ...
                                        <div class="user-name">
                                            <h6>By <span><a
                                                        href="{{ route('all/profile', $best->courses->user->id) }}">
                                                ...
                                                <ul>
                                                    ...
                                                    @if (Auth::check())
                                                        ...
                                                        @else
                                                            <li class="protip-wish-btn-two">
                                                                <form id="demo-form2" method="post"
                                                                    action="{{ url('remove/wishlist', $best->courses->id) }}"
                                                                    data-parsley-validate
                                                                    class="form-horizontal form-label-left">
                                                                    {{ csrf_field() }}
                            ...
                            <div id="prime-next-item-description-block{{ $best->courses->id }}"
                                class="prime-description-block">
                                <div class="prime-description-under-block">
                                    <div class="prime-description-under-block">
                                                ...
                                                <div class="col-lg-8">
                                                    @if ($best->courses->type == 1)
                                                        ...
                                                        @else
                                                            @if ($gsetting->guest_enable == 1)
                                                                <form id="demo-form2" method="post"
                                                                    action="{{ route('guest.addtocart', $best->courses->id) }}"
                                                                    data-parsley-validate
                                                                    class="form-horizontal form-label-left">
                                                                    {{ csrf_field() }}
                                                                    <div class="box-footer">
                                                    ...
                                                    @else
                                                        @if (Auth::check())
                                                            ...
                                                            @else
                                                                ...
                                                                @if ($enroll == null)
                                                                    <div class="protip-btn">
                                                                        <a href="{{ url('enroll/show', $best->courses->id) }}"
                                                                            class="btn btn-primary"
                                                                            title="Enroll Now"><i
                                                                                data-feather="shopping-cart"></i>{{ __('Enroll Now') }}</a>
                                                                    </div>
                        ...
                        @if (!$meetings->isEmpty())
                            @foreach ($meetings as $meeting)
                                <div class="item student-view-block student-view-block-1">
                                        ...
                                        <div class="view-block">
                                            <div class="view-img">
                                                ...
                                                @if ($meeting['image'] !== null && $meeting['image'] !== '')
                                                    <a href="{{ route('zoom.detail', $meeting->id) }}"><img
                                                            data-src="{{ asset('images/zoom/' . $meeting['image']) }}"
                                                            alt="course" class="img-fluid owl-lazy"></a>
                                                @else
                                                    <a href="{{ route('zoom.detail', $meeting->id) }}"><img
                                                            data-src="{{ Avatar::create($meeting['meeting_title'])->toBase64() }}"
                                                            alt="course" class="img-fluid owl-lazy"></a>
                                                @endif
                                            ...
                                            <div class="view-user-img">
                                                ...
                                                @if (optional($meeting->user)['user_img'] !== null && optional($meeting->user)['user_img'] !== '')
                                                    <a href="{{ route('all/profile', $meeting->user->id) }}"
                                                        title=""><img
                                                            src="{{ asset('images/user_img/' . $meeting->user['user_img']) }}"
                                                            class="img-fluid user-img-one" alt=""></a>
                                                @else
                                                    <a href="{{ route('all/profile', $meeting->user->id) }}"
                                                        title=""><img
                                            ...
                                            @if (asset('images/meeting_icons/zoom.png') == !null)
                                                <div class="meeting-icon"><img
                                                        src="{{ asset('images/meeting_icons/zoom.png') }}"
                                            ...
                                            <div class="view-dtl">
                                                ...
                                                <div class="user-name">
                                                    <h6>By <span><a
                                                                href="{{ route('all/profile', $meeting->user->id) }}">
                                                                {{ optional($meeting->user)['fname'] }}</a></span>
                                                    </h6>
                                                </div>
                                                <div class="view-footer">
                                                    <div class="row">
                                    ...
                                    <div id="prime-next-item-description-block-6{{ $meeting->id }}"
                                        class="prime-description-block">
                                        <div class="prime-description-under-block">
                                            <div class="prime-description-under-block">
                                                ...
                                                <div class="des-btn-block">
                                                    <a href="{{ $meeting->zoom_url }}"
                                                        class="iframe btn btn-light">{{ __('Join Meeting') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @if (!$bigblue->isEmpty())
                            @foreach ($bigblue as $bbl)
                                <div class="item student-view-block student-view-block-1">
                                        ...
                                        <div class="view-block">
                                            <div class="view-img">
                                                <a href="{{ route('bbl.detail', $bbl->id) }}"><img
                                                        data-src="{{ Avatar::create($bbl['meetingname'])->toBase64() }}"
                                                        alt="course" class="img-fluid owl-lazy"></a>
                                            </div>
                                            <div class="view-user-img">

                                                @if (optional($bbl->user)['user_img'] !== null && optional($bbl->user)['user_img'] !== '')
                                                    <a href="{{ route('all/profile', $bbl->user->id) }}"
                                                        title=""><img
                                                            src="{{ asset('images/user_img/' . $bbl->user['user_img']) }}"
                                                            class="img-fluid user-img-one" alt=""></a>
                                                @else
                                                    <a href="{{ route('all/profile', $bbl->user->id) }}"
                                                        title=""><img
                                            ...
                                            @if (asset('images/meeting_icons/bigblue.png') == !null)
                                                <div class="meeting-icon"><img
                                                        src="{{ asset('images/meeting_icons/bigblue.png') }}"
                                                        class="img-circle" alt=""></div>
                                            @endif
                                            ...
                                            <div class="view-dtl">
                                                ...
                                                <div class="user-name">
                                                    <h6>By <span><a
                                                                href="{{ route('all/profile', $bbl->user->id) }}">
                                    ...
                                    <div id="prime-next-item-description-block-7{{ $bbl->id }}"
                                        class="prime-description-block">
                                        <div class="prime-description-under-block">
                                            <div class="prime-description-under-block">
                                    ...
                                    <div class="genre-slide-image @if ($gsetting['course_hover'] == 1) protip @endif"
                                        ...
                                        <div class="view-block">
                                            <div class="view-img">
                                                ...
                                                @if ($meeting['image'] !== null && $meeting['image'] !== '')
                                                    <a
                                                        href="{{ route('googlemeetdetailpage.detail', $meeting['id']) }}"><img
                                            ...
                                            @if (asset('images/meeting_icons/google.png') == !null)
                                                <div class="meeting-icon"><img
                                                        src="{{ asset('images/meeting_icons/google.png') }}"
                                                        class="img-circle" alt=""></div>
                                            @endif
                                        ...
                                        <div class="prime-description-under-block">
                                            <div class="prime-description-under-block">
                                                ...
                                                <div class="protip-img">
                                                    ...
                                                    <p class="meeting-owner btm-10"><a
                                                            herf="#">{{ __('Meeting Owner:') }}
                                                            {{ $meeting->owner_id }}</a></p>
                                                </div>
                                                <div class="main-des meeting-main-des">
                                                ...
                                                <div class="des-btn-block">
                                                    <a href="{{ $meeting->meet_url }}" target="_blank"
                                                        class="btn btn-light">{{ __('Join') }}
                                                        {{ __('Meeting') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="genre-slide-image @if ($gsetting['course_hover'] == 1) protip @endif"
                                        ...
                                        <div class="view-block">
                                            <div class="view-img">
                                                @if ($meeting['image'] !== null && $meeting['image'] !== '')
                                                    <a href="{{ route('jitsipage.detail', $meeting['id']) }}"><img
                                                            data-src="{{ asset('images/jitsimeet/' . $meeting['image']) }}"
                                                            alt="course" class="img-fluid owl-lazy"></a>
                                                @else
                                                    <a href="{{ route('jitsipage.detail', $meeting['id']) }}"><img
                                                            data-src="{{ Avatar::create($meeting['meeting_title'])->toBase64() }}"
                                            ...
                                            @if (asset('images/meeting_icons/jitsi.png') == !null)
                                                <div class="meeting-icon"><img
                                                        src="{{ asset('images/meeting_icons/jitsi.png') }}"
                                                        class="img-circle" alt=""></div>
                                            @endif
                        ...
                        <div class="instructor-home-block text-center">
                            <div class="instructor-home-block-one">
                                @if ($inst->user->user_img !== null && $inst->user->user_img !== '')
                                    <a href="{{ route('allinstructor/profile', $inst->id) }}" title=""><img
                                            src="{{ url('/images/user_img/' . $inst->user->user_img) }}"
                                            class="img-fluid" /></a>
                                @else
                                    <a href="{{ route('allinstructor/profile', $inst->id) }}" title=""><img
                                            src="{{ Avatar::create($inst->user->fname)->toBase64() }}"
                                            alt="course" class="img-fluid"></a>
                                @endif
                                    ...
                                    <ul>
                                                ...
                                                <span class="tooltiptext">
                                                    <div class="instructor-home-social-icon">
                                                        <ul>
                                                            ...
                                                            @endphp
                                                            <li><a href="http://www.linkedin.com/shareArticle?mini=true&url={{ $url }}&title=Default+share+text&summary="
                                                                    target="_blank"><b><i class="fa fa-linkedin"
                                                                            aria-hidden="true"></i></b></a></li>
                                                            <li><a href="https://www.facebook.com/sharer/sharer.php?&url={{ $url }}"
                                                                    target="_blank"><b><i
                                                                            class="fa fa-facebook-square"
                                                                            aria-hidden="true"></i></b></a></li>
                                                            <li><a href="https://twitter.com/intent/tweet?text=Default+share+text&url={{ $url }}"
                                                                    target="_blank"><b><i class="fa fa-twitter"
                                                                            aria-hidden="true"></i></b></a></li>
                                                            <li><a href="https://telegram.me/share/url?url={{ $url }}&text=Default+share+text"
                                                                    target="_blank"><b><i class="fa fa-telegram"
                                                                            aria-hidden="true"></i></b></a></li>
                                                            <li><a href="https://wa.me/?text={{ $url }}"
                                                                    target="_blank"><b><i class="fa fa-whatsapp"
                                                                            aria-hidden="true"></i></b></a></li>
                                                        </ul>
                                                    </div>
                                                </span>
                                        ...
                                        <li>
                                            <div class="instructor-home-btn">
                                                <a href="{{ route('allinstructor/profile', $inst->id) }}"
                                                    class="btn btn-primary" title="View Profile"><i
                                ...
                                <div class="instructor-home-dtl">
                                    <h4 class="instructor-home-heading"><a href="#"
                                            title="">{{ $inst->fname }} {{ $inst->lname }}</a></h4>
                                    <p>{{ $inst->role }}</p>
            ...
            <div id="blog-post-slider" class="student-view-slider-main-block owl-carousel">
                @foreach ($blogs as $blog)
                    <div class="item student-view-block student-view-block-1">
                            ...
                            <div class="view-block">
                                <div class="view-img">
                                    @if ($blog['image'] !== null && $blog['image'] !== '')
                                        @if ($blog->slug != null)
                                            <a
                                                href="{{ route('blog.detail', ['id' => $blog->id, 'slug' => $blog->slug]) }}">
                                            @else
                                                <a
                                                    href="{{ route('blog.detail', ['id' => $blog->id, 'slug' => str_slug(str_replace('-', '&', $blog->heading))]) }}">
                                        @endif

                                        <img data-src="{{ asset('images/blog/' . $blog['image']) }}"
                                        ...
                                        @if ($blog->slug != null)
                                            ...
                                            @else
                                                <a
                                                    href="{{ route('blog.detail', ['id' => $blog->id, 'slug' => str_slug(str_replace('-', '&', $blog->heading))]) }}">
                                        @endif
                                        <img data-src="{{ Avatar::create($blog->heading)->toBase64() }}"
                                            alt="course" class="img-fluid owl-lazy">
                                        </a>
                                    @endif
                                </div>
                                <div class="view-user-img">
                                    ...
                                    @if (optional($blog->user)['user_img'] !== null && optional($blog->user)['user_img'] !== '')
                                        <a href="{{ route('all/profile', $blog->user->id) }}" title=""><img
                                                src="{{ asset('images/user_img/' . $blog->user['user_img']) }}"
                                                class="img-fluid user-img-one" alt=""></a>
                                    @else
                                        <a href="{{ route('all/profile', $blog->user->id) }}" title=""><img
                                                src="{{ asset('images/default/user.png') }}"
                                ...
                                <div class="tooltip">
                                    ...
                                    <span class="tooltiptext">
                                        <div class="instructor-home-social-icon">
                                            <ul>
                                                <li><a href="{{ $blog->user->fb_url }}"><i
                                                            data-feather="facebook"></i></a></li>
                                                <li><a href="{{ $blog->user->twitter_url }}"><i
                                                            data-feather="twitter"></i></a></li>
                                                <li><a href="{{ $blog->user->youtube_url }}"><i
                                                            data-feather="youtube"></i></a></li>
                                                <li><a href="{{ $blog->user->linkedin_url }}"><i
                        ...
                        <div id="prime-next-item-description-block-8{{ $blog->id }}"
                            class="prime-description-block">
                            <div class="prime-description-under-block">
                                <div class="prime-description-under-block">
                            ...
                            <div class="recommendations-block">
                                ...
                                <div class="recommendation-btn">
                                    <a href="" data-toggle="modal" data-target="#myModalinstructor"
                                        class="btn btn-primary"
                                        title="Become an Instructor">{{ __('Become an Instructor') }}</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="item">
                                    <div class="recommendations-img">
                                        @if ($gets['img'] !== null && $gets['img'] !== '')
                                            <img src="{{ url('/images/joininstructor/' . $gets->img) }}"
                                    ...
                                    <a
                                        ...
                                        <div class="cat-dtl">
                                            <div>
                                                <span>
                                                    <h5 class="cat-name"><i
                                                            class="fa {{ $t['icon'] }} mr-2"></i>{{ $t['title'] }}
                                                    </h5>
                                                    <div class="cat-img-count">{{ $t->courses->count() }}
                                                        {{ __('Courses') }}</div>
                                                </span>
                                            </div>
                                        </div>
            ...
            <div id="testimonial-slider" class="testimonial-slider-main-block owl-carousel">
                @foreach ($testi as $tes)
                    <div class="item testi-block text-center">
                        ...
                        <div class="testi-block-video text-center main-div">
                            <video width="200" height="150" class="video_video" controls
                                data-toggle="modal" data-target="#videoModal"
                                data-video-src="{{ asset('videos/testimonial/' . $tes->video) }}">
                                <source src="{{ asset('videos/testimonial/' . $tes->video) }}" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                        <div class="testi-name">
                            <h5 class="testi-heading" style="margin-right: -65px">{{ $tes['client_name'] }}</h5>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Testimonial Video</h5>
                ...
                <div class="modal-body">
                    <div class="embed-responsive embed-responsive-16by9">
                        <video class="embed-responsive-item" controls id="modalVideo">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="service-side-img">
                        @if ($servicesetting['image'] == !null)
                            <img src="{{ asset('images/services/' . $servicesetting['image']) }}"
                                class="img-fluid" alt="">
                        @else
                            <img src="{{ Avatar::create($servicesetting->title)->toBase64() }}" class="img-fluid"
                                alt="">
                        @endif
                    ...
                    <div class="service-side-dtl text-center">
                        ...
                        <p class="mb-4">
                            {{ str_limit(preg_replace("/\r\n|\r|\n/", '', strip_tags(html_entity_decode($servicesetting->detail))), $limit = 300, $end = '...') }}
                        </p>
                        <a href="{{ route('front.service') }}" type="button" class="btn btn-primary mt-2"
                            title="View More">{{ __('View More') }} <i data-feather="chevrons-right"></i></a>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="service-block">
                                    <div class="service-img text-center">
                                        @if ($ser['image'] == !null)
                                            <img src="{{ asset('images/service/' . $ser['image']) }}"
                                                class="img-fluid" alt="">
                                        @else
    ...
    <section id="video" class="video-main-block">
        <div class="container-fluid p-0">
            @if ($videosetting['image'] !== null && $videosetting['image'] !== '')
                <div class="video-block parallax"
                    style="background-image: url({{ 'images/videosetting/' . $videosetting->image }});">
                @else
                    <div class="video-block parallax"
                        style="background-image: url({{ Avatar::create($videosetting->tittle)->toBase64() }});">
            @endif
            <div class="overlay-bg"></div>
        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe id="elearningVideo" class="embed-responsive-item" width="560"
                                    height="315" src="{{ $videosetting->url }}" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-5">
                    <div class="instructor-button txt-rgt">
                        <a href="{{ route('allinstructor/view') }}" class="btn btn-secondary"
                            title="All Instructor">{{ __('All Instructor') }}<i data-feather="chevrons-right"></i>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="instructor-home-block text-center">
                            <div class="instructor-home-block-one">
                                @if ($inst['user_img'] !== null && $inst['user_img'] !== '')
                                    <a href="{{ route('allinstructor/profile', $inst->id) }}" title=""><img
                                            src="{{ url('/images/user_img/' . $inst->user_img) }}"
                                            class="img-fluid" /></a>
                                @else
                                    <a href="{{ route('allinstructor/profile', $inst->id) }}" title=""><img
                                            src="{{ Avatar::create($inst->fname)->toBase64() }}" alt="course"
                                            class="img-fluid"></a>
                                @endif
                                <div class="instructor-home-hover-icon">
                                    <ul>
                                ...
                                <div class="instructor-home-dtl">
                                    <h4 class="instructor-home-heading"><a
                                            href="{{ route('allinstructor/profile', $inst->id) }}"
                                            title="">{{ $inst->fname }} {{ $inst->lname }}</a></h4>
                                    <p>{{ $inst->role }}</p>
        ...
        <div class="container-fluid p-0">
            <div class="get-started-block">
                @if ($get_enable['image'] !== null && $get_enable['image'] !== '')
                    <div class="get-started-bg-image parallax"
                        style="background-image: url({{ 'images/getstarted/' . $get_enable->image }});">
                    @else
                        <div class="get-started-bg-image parallax"
                            style="background-image: url({{ Avatar::create($get_enable->heading)->toBase64() }});">
                @endif
                <div class="overlay-bg"></div>
            </div>
            <div class="get-started-dtl text-center">
                ...
                <a href="{{ $get_enable->link }}" type="button"
                    class="btn btn-primary">{{ $get_enable->button_txt }}</a>
            </div>
        </div>
        </div>
    </section>
                        ...
                        <div class="instructor-home-block text-center">
                            <div class="instructor-home-block-one">
                                @if ($inst['image'] !== null && $inst['image'] !== '')
                                    <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"
                                        title=""><img src="{{ url('/files/institute/' . $inst->image) }}"
                                            class="img-fluid" /></a>
                                @else
                                    <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"
                                        title=""><img src="{{ Avatar::create($inst->fname)->toBase64() }}"
                                            alt="course" class="img-fluid"></a>
                                @endif
                                <div class="instructor-home-hover-icon">
                                    <ul>
                                        <li>
                                            <div class="instructor-home-btn">
                                                <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"
                                                    class="btn btn-primary" title="View Page"><i
                                                        data-feather="eye"></i></a>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="instructor-home-dtl">
                                    <h4 class="instructor-home-heading"><a
                                            href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"
                                            title="">{{ $inst->title }} </a></h4>
                                    <p>{{ $inst->email }}</p>
                                    <p>{{ $inst->phone }}</p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="feature-dtl-block">
                            ...
                            @foreach ($feature as $data)
                                <div class="col-lg-6 col-md-6 mb-4">
                                    <div class="feature-dtl-icon">
                                        @if ($data['image'] == !null)
                                            <img src="{{ asset('images/feature/' . $data['image']) }}"
                                                class="img-fluid" alt="">
                                        @else
                        ...
                        <a href="{{ route('front.feature') }}" type="button" class="btn btn-primary"
                            title="View More">{{ __('View More') }} <i data-feather="chevrons-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5">
                    <div class="feature-image">
                        @if ($featuresetting['image'] == !null)
                            <img src="{{ asset('images/feature/' . $featuresetting['image']) }}" class="img-fluid"
                                alt="">
                        @else
                            <img src="{{ Avatar::create($featuresetting->title)->toBase64() }}" class="img-fluid"
                                alt="">
                        @endif
                    </div>
                </div>
                    ...
                    @foreach ($trusted as $trust)
                        <div class="item-patners-img">
                            <a href="{{ $trust['url'] }}" target="_blank"><img
                                    data-src="{{ asset('images/trusted/' . $trust['image']) }}"
                                    class="img-fluid owl-lazy" alt="patners-1"></a>
                        </div>
                    @endforeach
                </div>
            </div>
