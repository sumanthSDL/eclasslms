                            ...
                            <div class="tooltip">
                                ...
                                <span class="tooltiptext">
                                    <div class="instructor-home-social-icon">
                                        <ul>
                                            <li><a href="{{ $instructors->fb_url }}"><i data-feather="facebook"></i></a>
                                            </li>
                                            <li><a href="{{ $instructors->twitter_url }}"><i data-feather="twitter"></i></a>
                                            </li>
                        ...
                        <ul class="nav nav-tabs" id="tabs-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="classes-tab" data-toggle="tab" href="#classes" role="tab"
                                    aria-controls="classes" aria-selected="false">{{ __('Explore Courses') }}</a>
                            </li>
                        </ul>
                                                        ...
                                                        <div class="student-view-block">
                                                            <div class="view-block">
                                                                ...
                                                                <div class="view-user-img">
                                                                    ...
                                                                    @if (optional($c->user)['user_img'] !== null && optional($c->user)['user_img'] !== '')
                                                                        <a href="" title=""><img
                                                                                ...
                                                                                class="img-fluid user-img-one user-img-three"
                                                                                alt=""></a>
                                                                    @else
                                                                        <a href="" title=""><img
                                                                ...
                                                                <div class="view-dtl">
                                                                    ...
                                                                    <div class="user-name">
                                                                        <h6>By <span><a
                                                                                    href="">{{ optional($c->user)['fname'] }}</a></span>
                                                                        </h6>
                                                                    </div>
                                                                    <div class="rating">
                                                                        <ul>
