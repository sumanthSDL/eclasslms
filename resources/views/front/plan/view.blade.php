                            ...
                            <div class="col-lg-3 col-sm-6 col-md-4">
                                <div class="view-block btm-10">
                                    <div class="view-img">
                                        @if ($subscrib->plans['preview_image'] !== null && $subscrib->plans['preview_image'] !== '')
                                            <img src="{{ asset('images/plan/' . $subscrib->plans->preview_image) }}"
                                                class="img-fluid" alt="{{ __('course') }}">
                                        @else
                                            <a href=""><img
                                                    src="{{ Avatar::create($subscrib->plans->title)->toBase64() }}"
                                                    class="img-fluid" alt="{{ __('course') }}">
                                        @endif
                                        </a>
                                    </div>
                                    ...
                                    <div class="view-dtl">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="view-heading"><a
                                                        href="">{{ str_limit($subscrib->plans->title, $limit = 35, $end = '...') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            @if ($subscrib->plans->discount_price == !null)
                                                                <li class="rate-r"><s>
                                                                        @if ($subscrib->plans->type == 1)
                                                                            <i
                                                                                class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }}
                                                                            /
                                                                        @endif
                                                                        {{ $subscrib->plans->duration }}
                                                                        {{ __('Month') }}
                                                                    </s></li>
                                                                ...
                                                                <li><b>
                                                                        @if ($subscrib->plans->type == 1)
                                                                            <i
                                                                                class="{{ $currency->icon }}"></i>{{ $subscrib->plans->discount_price }}/
                                                                        @endif
                                                                        {{ $subscrib->plans->duration }}
                                                                        {{ __('Month') }}
                                                                    </b></li>
                                                            @else
                                                                <li class="rate-r">
                                                                    @if ($subscrib->plans->type == 1)
                                                                        ...
                                                                        /
                                                                    @endif
                                                                    {{ $subscrib->plans->duration }} {{ __('Month') }}
                                                                </li>
                                                            @endif
                                                        @else
                                                            @if ($subscrib->plans->discount_price == !null)
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="inst-allowed-courses">{{ $subscrib->plans->courses_allowed }}
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="plan-subs-btn">
                                    <button type="submit" class="btn btn-primary"
                                        title="Add To Cart">{{ __('Subscribed') }}</button>
                                </div>
                            </div>
                        @endif
                    @endforeach
                    ...
                    @if ($plan->status == '1')
                        ...
                        <div class="col-lg-3 col-sm-6 col-md-4">
                            <div class="genre-slide-image @if ($gsetting['course_hover'] == 1) protip @endif"
                                ...
                                data-pt-title="#prime-next-item-description-block{{ $plan->id }}">
                                <div class="view-block btm-10">
                                    <div class="view-img">
                                        @if ($plan['preview_image'] !== null && $plan['preview_image'] !== '')
                                            <a href=""><img src="{{ asset('images/plan/' . $plan->preview_image) }}"
                                                    class="img-fluid" alt="course">
                                            @else
                                                <a href=""><img src="{{ Avatar::create($plan->title)->toBase64() }}"
                                                        class="img-fluid" alt="course">
                                        @endif
                                        </a>
                                    </div>
                                    ...
                                    <div class="view-dtl">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="view-heading"><a
                                                        href="">{{ str_limit($plan->title, $limit = 35, $end = '...') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        @if ($plan->duration == 'm')
                                                            @if ($plan->discount_price == !null)
                                                                <li class="rate-r"><s>
                                                                        @if ($plan->type == 1)
                                                                            <i
                                                                                class="{{ $currency->icon }}"></i>{{ $plan->price }}
                                                                            /
                                                                        @endif {{ $plan->duration }}
                                                                        {{ __('Month') }}
                                                                    </s></li>
                                                                ...
                                                                <li><b>
                                                                        @if ($plan->type == 1)
                                                                            <i
                                                                                class="{{ $currency->icon }}"></i>{{ $plan->discount_price }}
                                                                            /
                                                                        @endif {{ $plan->duration }}
                                                                        {{ __('Month') }}
                                                                    </b></li>
                            ...
                            <div id="prime-next-item-description-block{{ $plan->id }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        ...
                                        @if ($plan->type == 1)
                                            <div class="plan-enroll-btn btm-10">
                                                <form id="demo-form2" method="post"
                                                    action="{{ route('plan.checkout') }}" data-parsley-validate
                                        ...
                                        @else
                                            <div class="plan-enroll-btn btm-10">
                                                <form id="demo-form2" method="post"
                                                    action="{{ route('free.plan.checkout') }}" data-parsley-validate
                                                    class="form-horizontal form-label-left">
                                                    {{ csrf_field() }}
