            ...
            <div class="col-lg-8">
                ...
                <ul>
                    <li>
                        ...
                        $sub_total = 0;
                        $sub_total = 0;
                        $reviews = App\ReviewRating::where('course_id', $course->id)
                            ->where('status', '1')
                            ->get();
                        ?>
                        @if (!empty($reviews[0]))
            ...
            <div class="col-lg-8 col-md-8">
                <div class="about-home-block">
                    ...
                    <ul>
                        ...
                        <li><a href="#" title="About">{{ __('Created') }}: @if (isset($course->user))
                                    <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname]) }}"
                                        title="{{ __('instructor') }}"> {{ $course->user['fname'] }}
                                        {{ $course->user['lname'] }} </a>
                                @endif
                            </a>
                        </li>
                        ...
                        @if ($course['language_id'] == !null)
                            @if (isset($course->language))
                                <li><a href="#" title="About"><i class="fa fa-comment"></i></a>
                ...
                <div class="about-home-product">
                    <div class="video-item hidden-xs">
                        <script type="text/javascript">
                            @if ($course->video != '')
                                var video_url =
                                    '<iframe src="{{ asset('video/preview/' . $course['video']) }}" frameborder="0" allowfullscreen></iframe>';
                            @endif
                            @if ($course->url != '')
                                var video_url =
                                    '<iframe src="{{ str_replace('watch?v=', 'embed/', $course['url']) }}" frameborder="0" allowfullscreen></iframe>';
                            @endif
                        </script>
                                    ...
                                    <div class="about-home-rate">
                                        <ul>
                                            ...
                                            @if ($course->discount_price == !null)
                                                ...
                                                {{-- <li>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($course->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}
                                                </li>
                                                <li><span><s>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($course->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</s></span>
                                                </li> --}}
                                            @else
                                                @if ($course->price == !null)
                                                    {{-- <li>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($course->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}
                                                    </li> --}}
                                                @endif
                                            @endif
                                        ...
                                        @else
                                            @if (isset($course->duration))
                                                @if ($course->duration_type == 'm')
                                                    <div class="course-duration btm-10">{{ __('Enroll Duration') }}:
                                                        {{ $course->duration }} Months</div>
                                                @else
                                                    <div class="course-duration btm-10">{{ __('Enroll Duration') }}:
                                                        {{ $course->duration }} Days</div>
                                                @endif
                                            @endif
                                                        ...
                                                        <form id="demo-form2" method="post"
                                                            ...
                                                            <div class="box-footer">
                                                                <button type="submit" class="btn btn-primary"><i
                                                                        ...
                                                                        aria-hidden="true"></i>&nbsp;{{ __('Cancel') }}</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                @else
                                                        ...
                                                        <form id="demo-form2" method="post"
                                                            ...
                                                            <div class="box-footer">
                                                                <button type="submit" class="btn btn-primary"><i
                                                                        ...
                                                                        aria-hidden="true"></i>&nbsp;{{ __('Enroll now') }}</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    {{-- <div class="about-home-btn btm-20">
                                                        <form id="demo-form2" method="post"
                                                            action="{{ route('buynow') }}" data-parsley-validate
                                                            class="form-horizontal form-label-left">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="box-footer">
                                                                <button type="submit"
                                                                    class="btn btn-primary">&nbsp;{{ __('BUY NOW') }}</button>
                                                            </div>
                                                        </form>
                                                    </div> --}}
                                                @endif
                                    ...
                                    @else
                                        <div class="about-home-btn btm-20">
                                            @if ($gsetting->guest_enable == 1)
                                                <form id="demo-form2" method="post"
                                                    action="{{ route('guest.addtocart', $course->id) }}"
                                    ...
                                    <div class="refund-policy-block">
                                        @if (isset($course->policy))
                                            ...
                                            <div class="money-back-days">
                                                {{ $days }}-{{ __('Day Money-Back Guarantee') }}
                                                    ...
                                                    <span class="badge badge-secondary">
                                                        ...
                                                        <div class="badge-button">
                                                            <form method="GET" id="searchform"
                                                                action="{{ route('search') }}">
                                                                <input name="searchTerm" value="{{ $tag }}"
                                                                    type="hidden" />
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="about-home-share text-center">
                                            <a href="https://calendar.google.com/calendar/r/eventedit?text={{ $course['title'] }}"
                                                target="__blank"><i data-feather="calendar"></i></a>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="about-home-share text-center">
                                            <a href="#" data-toggle="modal" data-target="#myModalshare"
                                                title="Share" data-dismiss="modal"><i data-feather="share"></i></a>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="about-home-share text-center">
                                            @auth
                                                @if ($course->type == 1)
                                                    <div><a href="{{ route('gift.view', ['id' => $course->id, 'slug' => $course->slug]) }}"
                                                            title="Gift"><i data-feather="gift"></i></a></div>
                                                @endif

                                            @endauth
                                            @guest
                                                @if ($course->type == 1)
                                                    <div><a href="{{ route('login') }}" title="Gift"><i
                                                                data-feather="gift"></i></a></div>
                                                @endif
                                            @endguest
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="about-home-share text-center">
                                            @if (Auth::check())
                                                    ...
                                                    <div class="about-icon-one">
                                                        <form id="demo-form2" method="post"
                                                            ...
                                                            <button class="wishlisht-btn"
                                                                title="{{ __('Add to wishlist') }}" type="submit"><i
                                                ...
                                                @endif
                                            @else
                                                <div class="about-icon-one"><a href="{{ route('login') }}"
                                                        title="Add to wishlist"><i data-feather="heart"></i></a></div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col">
                                            ...
                                            @if (Auth::check())
                                                <div class="report-abuse text-center">
                                                    <a href="#" data-toggle="modal"
                                                        data-target="#myModalCourse" title="Report"><i
                                                            data-feather="flag"></i></a>
                                                </div>
                                            @else
                                                <div class="report-abuse text-center">
                                                ...
                                                <div class="panel panel-sum">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="nav-search">
                                                            ...
                                                            <button onclick="myFunction()" class="btn btn-primary"><i
                        ...
                        <div class="container-xl">
                            <div class="about-content-img">
                                @if ($course->user['user_img'] !== null && $course->user['user_img'] !== '')
                                    <img src="{{ asset('images/user_img/' . $course->user['user_img']) }}"
                                        class="img-fluid" alt="">
                                @else
                                    <img src="{{ asset('images/default/user.png') }}" class="img-fluid"
                                        alt="">
                                @endif
                                <h5 class="about-content-heading">{{ optional($course->user)['fname'] }}
                                    {{ optional($course->user)['lname'] }}</h5>
                            </div>
                            <div class="ratings">
                                @php
                            ...
                            <div class="about-reward-badges">
                                <img src="{{ url('images/badges/1.png') }}" class="img-fluid" alt=""
                                    ...
                                    title="Member Since {{ $course->user->created_at->diffForHumans() }}">
                                @if ($course_count >= 5)
                                ...
                                <img src="{{ url('images/badges/3.png') }}" class="img-fluid" alt=""
                                    data-toggle="tooltip" data-placement="bottom"
                                    title="Here user has applied {{ $enroll_count }} courses">
                                <img src="{{ url('images/badges/4.png') }}" class="img-fluid" alt=""
                                    data-toggle="tooltip" data-placement="bottom"
                                    title="Affiliate Users {{ $affiliate_user }}">
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname]) }}"
                                        class="btn btn-primary" title="course">{{ __('Profile') }}</a>
                                </div>
                                ...
                                @if (isset($insti))
                                    <div class="about-content-img">
                                        @if (isset($insti['image']) && $insti['image'] !== null && $insti['image'] !== '')
                                            <img src="{{ asset('files/institute/' . $insti->image) }}"
                                                class="img-fluid" alt="">
                                        @else
                                            <img src="{{ Avatar::create($insti->title)->toBase64() }}"
                                                class="img-fluid" alt="">
                                        @endif
                                ...
                                @if (isset($insti))
                                    <div class="about-reward-badges">
                                        ...
                                        <img src="{{ url('images/badges/4.png') }}" class="img-fluid"
                                            alt="" data-toggle="tooltip" data-placement="bottom"
                                            title="{{ $enroll_count }} users has enrolled">
                                    </div>


                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="{{ route('institute.view', ['id' => $insti->id, 'cour' => $course->id]) }}"
                                                class="btn btn-primary" title="course">{{ __('Profile') }}</a>
                                        </div>
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                        ...
                        <div class="row" style="padding-bottom:10px">
                            ...
                            <div class="col-lg-3 col-6 col-xs-6 text-right">
                                <button type="button" onclick="toggleAllSections()"
                                    class="btn btn-link courseToggle"><span
                                        style="color:#0384a3">{{ __('Expand all sections') }}</span></button>
                                <button type="button" onclick="toggleAllSections()"
                                    class="btn btn-link courseToggle" style="display:none"><span
                                        style="color:#0384a3">{{ __('Collapse all sections') }}</span></button>
                            </div>
                        </div>
                        <!-- FSMS -->
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="koh-tab-content">
                                                                                        <div
                                                                                            class="koh-tab-content-body">
                                                                                            <div class="koh-faq">
                                                                                                <div
                                                                                                    class="koh-faq-question">
                                                                                ...
                                                                                <td>
                                                                                    @if ($class->preview_url != null || $class->preview_video != null)
                                                                                        <a href="{{ route('lightbox', $class->id) }}"
                                                                                            class="iframe"
                                                                                            style="display: block;">{{ __('preview') }}</a>
                                                                                    @endif
                                            ...
                                            @foreach ($bigblue as $bbl)
                                                @if ($bbl->is_ended != 1)
                                                    <div class="card">
                                                        ...
                                                        <div id="collapseThree{{ $bbl->id }}" class="collapse"
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <li>
                                                                                    <a href="" data-toggle="modal"
                                                                                        ...
                                                                                        title="Join"
                                                                                        class="btn btn-light"
                                                                                        title="Course">{{ __('Join Meeting') }}</a>
                                                                                </li>
                                        ...
                                        <div id="accordion" class="second-accordion">
                                            ...
                                            @foreach ($meetings as $meeting)
                                                <div class="card">
                                                    ...
                                                    <div id="collapseFour{{ $meeting->id }}" class="collapse"
                        ...
                        <li class="comment more">
                            @if (strlen($course->requirement) > 400)
                                ...
                                <span class="read-more-content">
                                    {{ substr($course->requirement, 400, strlen($course->requirement)) }}
                ...
                @php
                    $alreadyrated = App\ReviewRating::where('course_id', $course->id)
                        ->limit(1)
                        ->first();
                @endphp
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 col-sm-9 col-8">
                                                    <div class="featured-review-img-dtl">
                                                        <div class="review-img-name"><span>
                                                ...
                                                <div class="review">{{ __('helpful') }}?
                                                    ...
                                                    @if (isset($help['review_like']) == '1')
                                                        <div class="helpful">
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('helpful', $course->id) }}"
                                                                data-parsley-validate
                                                                class="form-horizontal form-label-left">
                                                                {{ csrf_field() }}
                                                                ...
                                                                <input type="hidden" name="review_like"
                                                                    value="0" />

                                                                <button type="submit"
                                                                    class="btn btn-link lft-7 rgt-10 "><i
                                                                        class="fa fa-check"></i>
                                                                    {{ __('Yes') }}</button>
                                                            </form>
                                                        </div>
                                                    @else
                                                        <div class="helpful">
                                                            <form method="post"
                                                                ...
                                                                <button type="submit"
                                                                    class="btn btn-link lft-7 rgt-10 ">{{ __('Yes') }}</button>
                                                            </form>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if (isset($help['review_dislike']) == '1')
                                                        <div class="helpful">
                                                            ...
                                                            <form method="post"
                                                                ...
                                                                <input type="hidden" name="helpful" value="yes" />
                                                                <input type="hidden" name="review_dislike"
                                                                    value="0" />

                                                                <button type="submit"
                                                                    class="btn btn-link lft-7 rgt-10 "><i
                                                                        class="fa fa-check"></i>{{ __('No') }}</button>
                                                            </form>
                                                        </div>
                                                    @else
                                                        <div class="helpful">
                                                            <form method="post"
                                                                ...
                                                                <button type="submit"
                                                                    class="btn btn-link lft-7 rgt-10 ">{{ __('No') }}</button>
                                                            </form>
                                                        </div>
                                                    @endif
                ...
                <div class="students-bought btm-30">
                    ...
                    @php
                        $items = App\Course::orderBy('created_at', 'desc')
                            ->limit(5)
                            ->get();
                    @endphp
                            ...
                            <div class="course-bought-block">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 col-12">
                                        <div class="course-name btm-10"><a
                                                href="{{ route('user.course.show', ['id' => $item->id, 'slug' => $item->slug]) }}">{{ str_limit($item['title'], $limit = 35, $end = '...') }}</a>
                                        </div>
                                        <div class="course-user btm-10">
                                            <ul>
                                                <li><i data-feather="clock"></i>
                                                    <div class="course-update">
                                                        {{ date('F, jS Y', strtotime($item['updated_at'])) }}</div>
                                                </li>
                                                <li><i data-feather="user"></i>
                                                    <div class="course-user-count">{{ $item->order->count() }}</div>
                                                </li>
                                            </ul>
                                        </div>
                                        <p class="course-name-para">
                                            {{ str_limit($item->short_detail, $limit = 125, $end = '..') }}</p>
                                    </div>
                                        ...
                                        @if ($item->type == 1)
                                            @if ($item->discount_price == !null)
                                                <div class="course-currency txt-rgt">
                                                    <ul>
                                                        ...
                                                        {{-- <li class="rate">
                                                            {{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($item->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}
                                                        </li>

                                                        <li class="rate">
                                                            <s>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($item->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</s>
                                                        </li> --}}
                                            ...
                                            @else
                                                <div class="course-currency txt-rgt">
                                                    <ul>
                                                        @if ($item->price == !null)
                                                            <li>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($item->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</s>
                                                            </li>
                                                        @endif
                    ...
                    <div class="student-feedback btm-40">
                        ...
                        <div class="student-feedback-block">
                            ...
                            <div class="rating">
                                ...
                                @else
                                    <div class="pull-left">
                                        <div class="star-ratings-sprite star-ratings-center"><span style="width:%"
                                                class="star-ratings-sprite-rating"></span>
                                        </div>
                                    </div>
                                @endif
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="star-rating">
                                                                    <input id="option1" type="radio" name="learn"
                                                                        value="5" />
                                                                    <label for="option1" title="5 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option2" type="radio" name="learn"
                                                                        value="4" />
                                                                    <label for="option2" title="4 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option3" type="radio" name="learn"
                                                                        value="3" />
                                                                    <label for="option3" title="3 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option4" type="radio" name="learn"
                                                                        value="2" />
                                                                    <label for="option4" title="2 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option5" type="radio" name="learn"
                                                                        value="1" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="star-rating">
                                                                    <input id="option6" type="radio" name="price"
                                                                        value="5" />
                                                                    <label for="option6" title="5 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option7" type="radio" name="price"
                                                                        value="4" />
                                                                    <label for="option7" title="4 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option8" type="radio" name="price"
                                                                        value="3" />
                                                                    <label for="option8" title="3 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option9" type="radio" name="price"
                                                                        value="2" />
                                                                    <label for="option9" title="2 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option10" type="radio" name="price"
                                                                        value="1" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="star-rating">
                                                                    ...
                                                                    <input id="option13" type="radio" name="value"
                                                                        value="3" />
                                                                    <label for="option13" title="3 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option14" type="radio" name="value"
                                                                        value="2" />
                                                                    <label for="option14" title="2 stars">
                                                                        <i class="active fa fa-star mrg-lft"
                                                                            aria-hidden="true"></i>
                                                                    </label>
                                                                    <input id="option15" type="radio" name="value"
                                                                        value="1" />
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="review-img-block">
                                                    <div class="review-month">
                                                        {{ date('d-m-Y', strtotime($rating['created_at'])) }}</div>
                                                    <div class="review-name">{{ $rating->user['fname'] }}
                                                        {{ $rating->user['lname'] }}</div>
                                                </div>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="review-rating">
                                                    <div class="pull-left-review">
                                                        <div class="star-ratings-sprite"><span
                                                                style="width:<?php echo $ratings_var7; ?>%"
                                                                class="star-ratings-sprite-rating"></span>
                                                        </div>
                                                    </div>
                                                                            ...
                                                                            <div class="panel panel-sum">
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form id="demo-form2" method="post"
                                                                                        ...
                                                                                        <div class="box-footer">
                                                                                            <button type="submit"
                                                                                                class="btn btn-lg col-md-3 btn-primary">{{ __('Submit') }}</button>
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div class="view-block">
                                                    ...
                                                    <div class="view-user-img">
                                                        @if ($rel->user['user_img'] !== null && $rel->user['user_img'] !== '')
                                                            <a href="{{ route('all/profile', $rel->user->id) }}"
                                                                title=""><img
                                                                    src="{{ asset('images/user_img/' . $rel->user['user_img']) }}"
                                                            ...
                                                            <ul>
                                                                ...
                                                                @if (Auth::check())
                                                                    <li class="protip-wish-btn"><a class="compare"
                                                                            data-id="{{ filter_var($rel->courses->id) }}"
                                                                            title="compare"><i
                                                                                data-feather="bar-chart"></i></a></li>

                                                                    @php
                                                                        $wish = App\Wishlist::where('user_id', Auth::User()->id)
                                                                            ->where('course_id', $rel->courses->id)
                                                                            ->first();
                                                                    @endphp
                                                                    @if ($wish == null)
                                                                        <li class="protip-wish-btn">
                                                                            <form id="demo-form2" method="post"
                                                                                action="{{ url('show/wishlist', $rel->courses->id) }}"
                                                                                data-parsley-validate
                                                                                class="form-horizontal form-label-left">
                                                                                {{ csrf_field() }}
                                                                    ...
                                                                    @else
                                                                        <li class="protip-wish-btn-two">
                                                                            <form id="demo-form2" method="post"
                                                                                action="{{ url('remove/wishlist', $rel->courses->id) }}"
                                                                                data-parsley-validate
                                                                                class="form-horizontal form-label-left">
                                                                                {{ csrf_field() }}
                                                    ...
                                                    <div class="view-dtl">
                                                        ...
                                                        <div class="user-name">
                                                            <h6>By <span><a
                                                                        href="{{ route('all/profile', $rel->user->id) }}">
                                                                        {{ optional($rel->courses->user)['fname'] }}</a></span>
                                                            </h6>
                                                        </div>
                                                        <div class="rating">
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    $sub_total = 0;
                                                                    $sub_total = 0;
                                                                    $reviews = App\ReviewRating::where('course_id', $rel->course_id)
                                                                        ->where('status', '1')
                                                                        ->get();
                                                                    ?>
                                                                    @if (!empty($reviews[0]))
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                                                    @if ($rel->courses->type == 1)
                                                                        @if ($rel->courses->discount_price == !null)
                                                                            {{-- <div class="rate text-right">
                                                                                <ul>
                                                                                    ...
                                                                                    <li><a><b>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($rel->courses->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</b></a>
                                                                                    </li>

                                                                                    <li><a><b><strike>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($rel->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</strike></b></a>
                                                                                    </li>
                                                                        ...
                                                                        @else
                                                                            {{-- <div class="rate text-right">
                                                                                <ul>
                                                                                    <li><a><b>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($rel->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</b></a>
                                                                                    </li>
                                ...
                                <div class="box box-primary">
                                    <div class="panel panel-sum">
                                        <div class="modal-body">
                                            ...
                                            <form id="demo-form2" method="post"
                                                action="{{ route('course.report', $course->id) }}" data-parsley-validate
                                                class="form-horizontal form-label-left">
                                                {{ csrf_field() }}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="detail">{{ __('Detail') }}:<sup
                                                                    class="redstar">*</sup></label>
                                                            <textarea name="detail" rows="4" class="form-control" placeholder="{{ __('Please Enter Detail') }}"
                                                                required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
