                                ...
                                <div class="btn-group mt-2 mb-4">
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        ...
                                        <label id="listview" class="btn btn-outline-dark">
                                            <input type="radio" name="layout" id="layout4" checked> <i
                                                data-feather="list"></i>
                                        </label>
                                    </div>
                                </div>
                                        ...
                                        <div class="search-item col-lg-3">
                                            @if ($course->status == 1)
                                                <div class="item first">
                                                    <div class="course-bought-section protip" data-pt-placement="outside"
                                                        ...
                                                        <div class="view-img">
                                                            ...
                                                            @if ($course['level_tags'] == 'trending')
                                                                <div class="advance-badge">
                                                                    <span
                                                                        class="badge bg-warning">{{ __('Trending') }}</span>
                                                                </div>
                                                            @endif
                                                            @if ($course['level_tags'] == 'featured')
                                                                <div class="advance-badge">
                                                                    <span
                                                                        class="badge bg-danger">{{ __('Featured') }}</span>
                                                                </div>
                                                            @endif
                                                            @if ($course['level_tags'] == 'new')
                                                                <div class="advance-badge">
                                                                    <span
                                                                        class="badge bg-success">{{ __('New') }}</span>
                                                                </div>
                                                            @endif
                                                            ...
                                                            @if ($course['level_tags'] == 'bestseller')
                                                                <div class="advance-badge">
                                                                    <span
                                                                        class="badge bg-success">{{ __('Bestseller') }}</span>
                                                                </div>
                                                            @endif
                                                            @if ($course['level_tags'] == 'beginner')
                                                                <div class="advance-badge">
                                                                    <span
                                                                        class="badge bg-primary">{{ __('Beginner') }}</span>
                                                                </div>
                                                            @endif
                                                        ...
                                                        <div class="view-dtl">
                                                            ...
                                                            <div class="categories-popularity-dtl">
                                                                ...
                                                                <p>{{ str_limit($course->short_detail, $limit = 60, $end = '..') }}
                                                                </p>
                                                            </div>
                                                            <div class="rating">
                                                                <ul>
                                                                        ...
                                                                        @foreach ($course['whatlearns'] as $wl)
                                                                            @if ($wl->status == 1)
                                                                                <div
                                                                                    ...
                                                                                    <ul>
                                                                                        <li><i
                                                                                                class="fa fa-check"></i>{{ str_limit($wl['detail'], $limit = 120, $end = '...') }}
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                            @endif
