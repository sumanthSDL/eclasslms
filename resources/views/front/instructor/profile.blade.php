                    ...
                    <div class="instructor-profile-block text-center">
                        <div class="instructor-profile-img">
                            @if (isset($instructors['user_img']))
                                ...
                                @else
                                    <img src="{{ Avatar::create($instructors->fname)->toBase64() }}"
                                        alt="{{ __('course') }}" class="img-fluid">
                                @endif
                            @endif
                            <div class="tooltip">
                                ...
                                <span class="tooltiptext">
                                    <div class="instructor-home-social-icon">
                                        <ul>
                                            <li><a href="{{ $instructors->fb_url ?? '-' }}"><i
                                                        data-feather="facebook"></i></a></li>
                                            <li><a href="{{ $instructors->twitter_url ?? '-' }}"><i
                                                        data-feather="twitter"></i></a></li>
                                            <li><a href="{{ $instructors->youtube_url ?? '-' }}"></a><i
                                                    data-feather="youtube"></i></a></li>
                                            <li><a href="{{ $instructors->linkedin_url ?? '-' }}"><i
                        ...
                        <div class="instructor-profile-dtl">
                            <div class="instructor-content-block">
                                <h5 class="about-content-heading">{{ $instructors->fname ?? '-' }}
                                    {{ $instructors->lname ?? '-' }}</h5>
                                ...
                                @if (isset($instructors->id))
                                    @php
                                        ...
                                        $followers = App\Followers::where('user_id', '!=', $instructors->id)
                                            ->where('follower_id', $instructors->id)
                                            ->count();
                                        
                                        $followings = App\Followers::where('user_id', $instructors->id)
                                            ->where('follower_id', '!=', $instructors->id)
                                            ->count();
                        ...
                        <ul class="nav nav-tabs" id="tabs-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="classes-tab" data-toggle="tab" href="#classes" role="tab"
                                    aria-controls="classes" aria-selected="true">{{ __('Explore Courses') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="about-tab" data-toggle="tab" href="#about" role="tab"
                                    aria-controls="about" aria-selected="false">{{ __('About me') }}</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="nav-tabContent">
                            @if (isset($courses))

                                <div class="tab-pane active show" id="classes" role="tabpanel"
