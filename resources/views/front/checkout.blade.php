                ...
                <div class="row">
                            ...
                            @if (isset($one_course) && $one_course == 1)
                                ...
                                <div class="row btm-10">
                                        ...
                                        <div class="checkout-course-img">
                                            @if ($cart->id != null)
                                                @if ($cart['preview_image'] !== null && $cart['preview_image'] !== '')
                                                    <a
                                                        href="{{ route('user.course.show', ['id' => $cart->id, 'slug' => $cart->slug]) }}"><img
                                                            src="{{ asset('images/course/' . $cart->preview_image) }}"
                                                            class="img-fluid" alt="course"></a>
                                                @else
                                                    <a
                                                        href="{{ route('user.course.show', ['id' => $cart->courses->id, 'slug' => $cart->slug]) }}"><img
                                                            src="{{ Avatar::create($cart->title)->toBase64() }}"
                                                            class="img-fluid" alt="course"></a>
                                                @endif
                                            @else
                                                @if ($cart->bundle['preview_image'] !== null && $cart->bundle['preview_image'] !== '')
                                                    <img src="{{ asset('images/bundle/' . $cart->bundle->preview_image) }}"
                                                        class="img-fluid" alt="blog">
                                                @else
                                                    <img src="{{ Avatar::create($cart->bundle->title)->toBase64() }}"
                                                        class="img-fluid" alt="blog">
                                                @endif
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-lg-9 col-8">
                                        <ul>
                                            @if ($cart->id != null)
                                                <li class="checkout-course-title"><a
                                                        href="{{ route('user.course.show', ['id' => $cart->id, 'slug' => $cart->slug]) }}">{{ str_limit($cart->title, $limit = 35, $end = '...') }}</a>
                                                </li>
                                            @else
                                                <li class="checkout-course-title"><a
                                                        href="{{ route('user.course.show', ['id' => $cart->bundle->id, 'slug' => $cart->bundle->slug]) }}">{{ str_limit($cart->bundle->title, $limit = 35, $end = '...') }}</a>
                                                </li>
                                            @endif
                                        ...
                                        <div class="row btm-10">
                                                ...
                                                <div class="checkout-course-img">
                                                    @if ($cart->course_id != null)
                                                        @if ($cart->courses['preview_image'] !== null && $cart->courses['preview_image'] !== '')
                                                            <a
                                                                href="{{ route('user.course.show', ['id' => $cart->courses->id, 'slug' => $cart->courses->slug]) }}"><img
                                                                    src="{{ asset('images/course/' . $cart->courses->preview_image) }}"
                                                                    class="img-fluid" alt="course"></a>
                                                        @else
                                                            <a
                                                                href="{{ route('user.course.show', ['id' => $cart->courses->id, 'slug' => $cart->courses->slug]) }}"><img
                                                                    src="{{ Avatar::create($cart->courses->title)->toBase64() }}"
                                                                    class="img-fluid" alt="course"></a>
                                                        @endif
                                                    @else
                                                        @if ($cart->bundle['preview_image'] !== null && $cart->bundle['preview_image'] !== '')
                                            ...
                                            <div class="col-lg-9 col-8">
                                                <ul>
                                                    @if ($cart->course_id != null)
                                                        <li class="checkout-course-title"><a
                                                                href="{{ route('user.course.show', ['id' => $cart->courses->id, 'slug' => $cart->courses->slug]) }}">{{ str_limit($cart->courses->title, $limit = 35, $end = '...') }}</a>
                                                        </li>
                                                    @else
                                                        <li class="checkout-course-title"><a
                                                                href="{{ route('user.course.show', ['id' => $cart->bundle->id, 'slug' => $cart->bundle->slug]) }}">{{ str_limit($cart->bundle->title, $limit = 35, $end = '...') }}</a>
                                                    ...
                                                    @endif
                                                    <li class="checkout-course-user">{{ __('By') }}
                                                        {{ $cart->user->fname }}</li>

                                                    @if ($cart->offer_price == !null)
                                                        <li class="checkout-course-price">
                                                            <b>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($cart->offer_price, $from = $currency->code, $to = $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</b>
                                                            <s>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($cart->price, $from = $currency->code, $to = $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</s>
                                                        </li>
                                                    @else
                                                        <li class="checkout-course-price">
                                                            <b>{{ activeCurrency()->getData()->position == 'l' ? activeCurrency()->getData()->symbol : '' }}{{ price_format(currency($cart->price, $from = $currency->code, $to = $currency->code, $format = false)) }}{{ activeCurrency()->getData()->position == 'r' ? activeCurrency()->getData()->symbol : '' }}</b>
                                                        </li>
                                                    @endif
                                                </ul>
                                            </div>
                    ...
                    <div class="col-lg-8 col-sm-8">
                        ...
                        <div class="checkout-pricelist">
                            <ul>
                                ...
                                {{-- <li>
                                    <div class="checkout-percent">{{ round($offer_percent, 0) }}% Off</div>
                                </li> --}}
                        ...
                        @if (session()->has('changed_currency'))
                            @if (session()->get('changed_currency') !== $currency->code)
                                <div class="h6 checkout-pricelist">
                                    ...
                                    ({{ __('Equivalent to your currency') }}
                                    {{ currency($cart_total, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }})
						...
						@endphp --}}
                        <div>
                            <p>Please contact the following numbers and address!!</p>
                        </div>
                                            ...
                                            <div class="card-header" id="headingThree">
                                                <div class="panel-title">
                                                    <label for='r13'>
                                                        ...
                                                        <img src="{{ url('images/payment/stripe.png') }}" class="img-fluid"
                                                            alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="payment">
                                                            <form accept-charset="UTF-8"
                                                                ...
                                                                <div class="form-group CVV">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="cvv" name="ccv" required>
                                                                </div>
                                                                <div class="form-group" id="card-number-field">
                                                                    <label
                                                                        for="cardNumber">{{ __('Card Number') }}</label>
                                                                    <input type="text" class="form-control"
                                                                        id="cardNumber" name="card_no" required>
                                                                </div>
                                                                ...
                                                                <div class="form-group" id="credit_cards">
                                                                    <img src="{{ url('images/payment/visa.jpg') }}"
                                                                        id="visa">
                                                                    <img src="{{ url('images/payment/mastercard.jpg') }}"
                                                                        id="mastercard">
                                                                    <img src="{{ url('images/payment/amex.jpg') }}"
                                                                        id="amex">
                                                                </div>
                                            ...
                                            <div class="card-header" id="headingThree">
                                                <div class="panel-title">
                                                    <label for='r13'>
                                                        ...
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#collapseThree"></a>
                                                        <img src="{{ url('images/payment/stripe.png') }}"
                                            ...
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='r11'>
                                                        ...
                                                        <img src="{{ url('images/payment/paypal2.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-header" id="headingTwo">
                                                <div class="panel-title">
                                                    <label for='r12'>
                                                        ...
                                                        <img src="{{ url('images/payment/instamojo.png') }}"
                                                            class="img-fluid-img" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="payment-proceed-btn">
                                                        ...
                                                        <form action="{{ url('pay') }}" method="POST"
                                                            name="laravel_instamojo" autocomplete="off">
                                                            {{ csrf_field() }}
                                    ...
                                    @if ($gsetting->enable_omise == 1 && $currency->code == 'THB')
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='omise'>
                                                        <input type='radio' id='omise' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#omise_panel"></a>

                                                        <img src="{{ url('images/payment/omise.svg') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        ...
                                                        <form id="checkoutForm" method="POST"
                                                            ...
                                                            <input type="hidden" name="amount"
                                                                value="{{ $mainpay }}" />
                                                            <script type="text/javascript" src="https://cdn.omise.co/omise.js" data-key="{{ env('OMISE_PUBLIC_KEY') }}"
                                                                data-amount="{{ $mainpay * 100 }}" data-frame-label="{{ config('app.name') }}"
                                                                data-image="{{ url('images/logo/' . $gsetting->logo) }}" data-currency="{{ $currency->code }}"
                                    ...
                                    @if ($gsetting->razorpay_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingSix">
                                                <div class="panel-title">
                                                    <label for='r16'>
                                                        <input type='radio' id='r16' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#collapseSix"></a>
                                                        <img src="{{ url('images/payment/razorpay.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        <form action="{{ route('dopayment') }}" method="POST">
                                                            ...
                                                            <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ env('RAZORPAY_KEY') }}"
                                                                data-amount="{{ $mainpay * 100 }}" data-currency="{{ $currency->code }}" data-order_id=""
                                                                data-buttontext="Proceed" data-name="{{ $gsetting->project_title }}" data-description=""
                                                                data-image="{{ asset('images/logo/' . $gsetting->logo) }}" data-prefill.name="XYZ"
                                                                data-prefill.email="info@example.com" data-theme.color="#F44A4A"></script>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if ($gsetting->paystack_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingSeven">
                                                <div class="panel-title">
                                                    <label for='r14'>
                                                        <input type='radio' id='r14' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#collapseSeven"></a>
                                                        <img src="{{ url('images/payment/paystack.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="collapseSeven" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    <div class="payment-proceed-btn">
                                                        <form method="POST" action="{{ route('paywithpaystack') }}"
                                                                ...
                                                                <div class="col-md-8 col-md-offset-2">
                                                                    ...
                                                                    <p>
                                                                        <button class="btn btn-primary " type="submit"
                                                                            value="Pay Now">{{ __('Proceed') }}</button>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </form>
                                    ...
                                    @if ($gsetting->paytm_enable == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingFour">
                                                <div class="panel-title">
                                                    <label for='r17'>
                                                        <input type='radio' id='r17' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#collapseFour"></a>
                                                        <img src="{{ url('images/payment/paytm.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="collapseFour" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    <div class="payment-proceed-btn">
                                                        <form method="post" action="{{ url('/paywithpayment') }}"
                                                            accept-charset="UTF-8" class="form-horizontal"
                                                            role="form">
                                                            @csrf
                                        ...
                                        @if ($banktransfer->bank_enable == '1')
                                            <div class="card">
                                                <div class="card-header" id="headingEight">
                                                    <div class="panel-title">
                                                        <label for='r18'>
                                                            <input type='radio' id='r18' name='occupation'
                                                                value='Working' required />
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                                href="#collapseEight"></a>
                                                ...
                                                <div id="collapseEight" class="panel-collapse collapse in">
                                                    <div class="card-body">
                                                        <div class="payment-proceed-btn">
                                                            <form method="POST"
                                                                action="{{ url('process/banktransfer') }}"
                                                                accept-charset="UTF-8" class="form-horizontal"
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item">
                                                                        <b>{{ __('Account holder name') }}:</b>&nbsp;{{ $bankdetail['account_holder_name'] }}
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        <b>{{ __('Bank Name') }}:</b>&nbsp;{{ $bankdetail['bank_name'] }}
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        <b>{{ __('Bank Acccoun tNumber') }}:</b>&nbsp;{{ $bankdetail['account_number'] }}
                                                                    </li>
                                                                    @if (isset($bankdetail['ifcs_code']))
                                                                        <li class="list-group-item">
                                                                            <b>{{ __('IFCS Code') }}</b>:&nbsp;{{ $bankdetail['ifcs_code'] }}
                                                                        </li>
                                                                    @endif
                                                                    @if (isset($bankdetail['swift_code']))
                                                                        <li class="list-group-item">
                                                                            <b>{{ __('Swift Code') }}</b>:&nbsp;{{ $bankdetail['swift_code'] }}
                                                                        </li>
                                                                    @endif
                                                                </ul>
                                                            </div>
                                    ...
                                    @if ($gsetting->enable_payu == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='ppay'>
                                                        <input type='radio' id='ppay' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#payupay"></a>

                                                        <img src="{{ url('images/payment/payumoney.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="payupay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        <form action="{{ route('paywithpayu') }}" method="POST"
                                                            autocomplete="off">
                                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input required="" name="phone" type="text"
                                                                    class="form-control"
                                                                    value="{{ Auth::user()->mobile }}"
                                                                    placeholder="{{ __('Enter valid phone no') }}">
                                                            </div>
                                    ...
                                    @if ($gsetting->enable_cashfree == 1)
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <div class="panel-title">
                                                    <label for='cpay'>
                                                        <input type='radio' id='cpay' name='occupation'
                                                            value='Working' required />
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            href="#cashfree_pay"></a>

                                                        <img src="{{ url('images/payment/cashfree.png') }}"
                                                            class="img-fluid" alt="course">
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="cashfree_pay" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    ...
                                                    <div class="payment-proceed-btn">
                                                        <form action="{{ route('cashfree.pay') }}" method="POST"
                                                            autocomplete="off">
                                                            @csrf
                    ...
                    @if ($gsetting->enable_moli == 1)
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <div class="panel-title">
                                    <label for='mpay'>
                                        <input type='radio' id='mpay' name='occupation' value='Working'
                                            required />
                    ...
                    @if ($gsetting->enable_skrill == 1)
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <div class="panel-title">
                                    <label for='skpay'>
                                        <input type='radio' id='skpay' name='occupation' value='Working'
                                            required />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="payment-proceed-btn">
                                        <form action="{{ route('skrill.pay') }}" method="POST" autocomplete="off">
                                            ...
                                            <input name="pay_to_email" type="hidden"
                    ...
                    @if ($gsetting->enable_rave == 1)
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <div class="panel-title">
                                    <label for='rpay'>
                                        <input type='radio' id='rpay' name='occupation' value='Working'
                                            required />
                            ...
                            <div id="rave_pay" class="panel-collapse collapse in">
                                <div class="card-body">
                                    ...
                                    <div class="payment-proceed-btn">
                                        ...
                                        @php
                                            $array = [['metaname' => 'color', 'metavalue' => 'blue'], ['metaname' => 'size', 'metavalue' => 'small']];
                                        ...
                                        <form method="POST" action="{{ route('flutterrave.pay') }}" id="paymentForm">
                                            ...
                                            <input required="" class="form-control" type="hidden" name="email"
                                                value="{{ Auth::user()->email }}" />
                                            <input type="hidden" name="name" value="{{ Auth::user()->fname }}" />

                                            <input type="hidden" name="phone" value="{{ Auth::user()->mobile }}" />
                                            <button class="btn btn-primary" title="checkout" type="submit">
                                                @if (session()->has('changed_currency'))
                                                    @if (session()->get('changed_currency') !== $currency->code)
                                                        <div class="h6 checkout-pricelist">
                                                    ...
                                                    @endif
                                                @endif
                                                {{ Crypt::decrypt($secureamount) }}{{ __('Proceed') }}
                                            </button>
                                        </form>
                    ...
                    @if ($gsetting->enable_payhere == 1)
                        <div class="card">
                            <div class="card-header" id="headingten">
                                <div class="panel-title">
                                    <label for='payhere'>
                                        <input type='radio' id='payhere' name='occupation' value='Working'
                                            required />
                                    ...
                                    <div class="payment-proceed-btn">
                                        ...
                                        <form method="post" action="{{ $action }}">
                                            ...
                                            <input type="hidden" name="return_url"
                                                value="{{ route('payhere.returnUrl') }}">
                                            <input type="hidden" name="cancel_url"
                                                value="{{ route('payhere.cancelUrl') }}">
                                            <input type="hidden" name="notify_url"
                                                value="{{ route('payhere.notifyUrl') }}">
                                            ...
                                            <input hidden type="text" name="first_name"
                                                value="{{ Auth::user()->fname }}">
                                            <input hidden type="text" name="last_name"
                                                value="{{ Auth::user()->lname }}">
                                            <input hidden type="text" name="email"
                                                value="{{ Auth::user()->email }}">
                                            <input hidden type="text" name="phone"
                                                value="{{ isset(Auth::user()['mobile']) }}">
                                            <input hidden type="text" name="address"
                                                value=" {{ isset(Auth::user()['address']) }}">
                                            <input type="hidden" name="city"
                                                value="{{ isset(Auth::user()->state['name']) }}">
                                            <input type="hidden" name="country"
                                                value="{{ isset(Auth::user()->country['name']) }}">
                    ...
                    @if ($gsetting->iyzico_enable == 1)
                        <div class="card">
                            <div class="card-header" id="headinggodvf">
                                <div class="panel-title">
                                    <label for='izyy'>
                                        <input type='radio' id='izyy' name='occupation' value='Working'
                                            required />
                                        <a data-toggle="collapse" data-parent="#accordion" href="#izyy_pay"></a>


                                        <img src="{{ url('images/payment/iyzico.png') }}" class="img-fluid"
                                            alt="iyzipay">
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="payment-proceed-btn">
                                        ...
                                        <form action="{{ route('izy.pay') }}" method="POST" autocomplete="off">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="email" class="form-control"
                                                            value="email@email.com" placeholder="email@email.com" required
                                                            autocomplete="off">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="mobile" class="form-control"
                                                            value="+905350000000" placeholder="+905350000000" required
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="identity_number" class="form-control"
                                                            value="74300864791" placeholder="74300864791" required
                                                            autocomplete="off">
                                            ...
                                            <input type="hidden" name="city"
                                                value="{{ isset(Auth::user()->city['name']) }}" />
                                            ...
                                            <input type="hidden" name="language"
                                                value="{{ Session::get('changed_language') }}" />
                    ...
                    @if ($gsetting->ssl_enable == 1)
                        <div class="card">
                            <div class="card-header" id="headingssl">
                                <div class="panel-title">
                                    <label for='ssl'>
                                        <input type='radio' id='ssl' name='occupation' value='Working'
                                            required />
                                        <a data-toggle="collapse" data-parent="#accordion" href="#ssl_pay"></a>


                                        <img src="{{ url('images/payment/ssl.png') }}" class="img-fluid"
                                            alt="sslpay">
                                    </label>
                                </div>
                            </div>
                    ...
                    @foreach ($manualpay as $manual)
                        <div class="card">
                            <div class="card-header" id="headingManual{{ $manual->id }}">
                                <h2 class="mb-0">
                                    <button class="btn btn-link" type="button" data-toggle="collapse"
                                        data-target="#collapseManual{{ $manual->id }}" aria-expanded="false"
                            ...
                            <div id="collapseManual{{ $manual->id }}" class="collapse"
                                aria-labelledby="headingManual" data-parent="#accordionExample">
                                <div class="card-body">


                                    <div class="payment-proceed-btn">
                                        <form action="{{ route('manualpay.checkout') }}" method="POST"
                                    ...
                                    @if ($manual->image != '' && file_exists(public_path() . '/images/manualpayment/' . $manual->image))
                                        <div class="card card-1">
                                            <div class="text-center card-body">
                                                ...
                                                <img width="300px" height="300px" class="img-fluid"
                                                    src="{{ url('images/manualpayment/' . $manual->image) }}"
                                                    alt="{{ $manual->image }}">
                                            </div>
                                        </div>
                                    @endif
                    ...
                    @if ($gsetting->aamarpay_enable == 1)
                        <div class="card">
                            <div class="card-header" id="headingaamar">
                                <div class="panel-title">
                                    <label for='aamar'>
                                        <input type='radio' id='aamar' name='occupation' value='Working'
                                            required />
                                        <a data-toggle="collapse" data-parent="#accordion" href="#aamar_pay"></a>


                                        <img src="{{ url('images/payment/aamarpay.png') }}" class="img-fluid"
                                            alt="aamarpay">
                                    </label>
                                </div>
                            </div>
                    ...
                    @if ($gsetting->braintree_enable == 1)
                        <div class="card">
                            <div class="card-header" id="headingFive">
                                <div class="panel-title">
                                    <label for='r15'>
                                        <input type='radio' id='r15' name='occupation' value='Working'
                                            required />
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive"></a>
                                        <img src="{{ url('images/payment/braintree.png') }}" style="margin-left: 15px;"
                                            height="30px" width="90px" class="img-fluid-img" alt="course">
                                    </label>
                            ...
                            <div id="collapseFive" class="panel-collapse collapse in">
                                <div class="card-body">
                                    <div class="payment-proceed-btn">
                                        ...
                                        <h3 class="plan-dtl-heading">{{ __('Checkout With Braintree') }}
                                        </h3>
                                        ...
                                        <form method="post" id="payment-form" action="{{ url('/checkout') }}">
                                                ...
                                                <label for="amount">
                                                    ...
                                                    <div class="input-wrapper amount-wrapper">
                                                        <input type='hidden' id="amount" name="amount"
                                                            type="tel" min="1" placeholder="Amount"
                                                            value="{{ $mainpay }}">
                                                    </div>
                                                </label>
                                            ...
                                            <button class="btn btn-primary"
                                                type="submit"><span>{{ __('Proceed') }}</span></button>
                                        </form>
                    ...
                    @if (isset($wallet_settings) && $wallet_settings->status == 1)
                        ...
                        <div class="card">
                            <div class="card-header" id="headingWallet">
                                <div class="panel-title">
                                    <label for='wallet'>
                                        <input type='radio' id='wallet' name='occupation' value='Working'
                                            required />
                                        <a data-toggle="collapse" data-parent="#accordion"
                                            href="#collapseWallet"></a>&emsp;
                            ...
                            <div id="collapseWallet" class="panel-collapse collapse in">
                                <div class="card-body">
                                    <div class="payment-proceed-btn">
                                        ...
                                        <h3 class="plan-dtl-heading">{{ __('Checkout With Wallet') }}
                                        </h3>
                                            ...
                                            @if (auth()->user()->wallet->status == 1)
                                                @if (round(auth()->user()->wallet->balance) >= sprintf('%.2f', Crypt::decrypt(strip_tags($secureamount))))
                                                    <form method="post" id="payment-form"
                                                        action="{{ url('wallet/checkout/wallet/payment') }}">
                                                        @csrf

                                                        <input id="nonce" name="amount" type="hidden"
                                                            value="{{ Crypt::decrypt($secureamount) }}" />
                                                ...
                                                @else
                                                    <h3 class="plan-dtl-heading">
                                                        {{ __('Insufficient Wallet Balance') }}</h3>
                                                @endif
                    ...
                    @if ($gsetting->payflexi_enable == 1)
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <div class="panel-title">
                                    <label for='payflexi'>
                                        <input type='radio' id='payflexi' name='occupation' value='Working'
                                            required />
                            ...
                            <div id="payflexi_pay" class="panel-collapse collapse in">
                                <div class="card-body">
                                    ...
                                    <div class="payment-proceed-btn">
                                        ...
                                        @php
                                            $array = ['title' => 'Online Course'];
                                        @endphp

                                        <form method="POST" action="{{ route('payflexi.pay') }}" id="paymentForm">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="key"
                                                value="{{ env('PAYFLEXI_SECRET_KEY') }}">
                                            <input type="hidden" name="amount"
                                                value="{{ Crypt::decrypt($secureamount) }}" />
                                            <input type="hidden" name="gateway"
                                                value="{{ env('PAYFLEXI_PAYMENT_GATEWAY') }}" />
                                            <input type="hidden" name="currency" value="{{ $currency->code }}" />
