                        ...
                        @else
                            <div class="cirtificate-border-one text-center">
                                <div class="cirtificate-border-two">
                                    <div class="cirtificate-heading" style=""> {{ __('Certificate of Completion') }}
                                    </div>
                                    @php
                                    ...
                                    <p class="cirtificate-detail" style="font-size:30px">
                                        ...
                                        <span
                                            style="font-size:25px">{{ date('jS F Y', strtotime($progress['updated_at'])) }}</span>
                                    </p>

                                    <span class="cirtificate-instructor">{{ $course->user['fname'] }}
                                        {{ $course->user['lname'] }}</span>
                                    <br>
                                    <span class="cirtificate-one">{{ $course->user['fname'] }}
                                        {{ $course->user['lname'] }}, {{ __('Instructor') }}</span>
                                    <br>
                                    <span>&</span>
                                    ...
                                    <div class="cirtificate-serial">{{ __('Certificate url.') }} :{{ url()->full() }}
                                    </div>
                ...
                <div class="col-lg-3 col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-4">
                                ...
                                @if ($progress->user->user_img != null || $progress->user->user_img != '')
                                    <img src="{{ asset('images/user_img/' . $progress->user->user_img) }}"
                                        alt="{{ __('user') }}" class="img-fluid img-circle">
                                @else
                                    <img src="{{ asset('images/default/user.jpg') }}" alt="{{ __('user') }}"
                    ...
                    <div class="view-block btm-20">
                        <div class="view-img">
                            ...
                            @else
                                <a href="{{ route('user.course.show', ['id' => $course->id, 'slug' => $course->slug]) }}"><img
                                        src="{{ Avatar::create($course->title)->toBase64() }}" alt="{{ __('course') }}"
                                        class="img-fluid"></a>
                            @endif
                        </div>
                        <div class="view-dtl">
                    ...
                    <div class="download-btn btm-20">
                        ...
                        @else
                            <a href="" onclick="printDiv('printableArea')" target="_blank"
                                class="btn btn-secondary">{{ __('Print Certificate') }}</a>
                        @endif
                    </div>
                    @auth
                        <p><a href="#" data-toggle="modal" data-target="#myModalCirtificate"
                                title="{{ __('report') }}">{{ __('Updateyourcertificate') }}</a>
                            {{ __('withy our correct name') }}.</p>
                                    ...
                                    <div class="box box-primary">
                                        <div class="panel panel-sum">
                                            <div class="modal-body">
                                                ...
                                                {{ __('Incorrect') }}? <a
                                                    href="{{ route('profile.show', Auth::User()->id) }}">{{ __('Update your profile name') }}</a>.
