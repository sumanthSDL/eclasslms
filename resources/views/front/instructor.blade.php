                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-7 col-12">
                                            <div class="instructor-content-block">
                                                <h5 class="about-content-heading">{{ $user['fname'] }} {{ $user['lname'] }}
                                                </h5>
                                                ...
                                                <div class="about-reward-badges">
                                                    ...
                                                    <img src="{{ url('images/badges/4.png') }}" class="img-fluid"
                                                        alt="" data-toggle="tooltip" data-placement="bottom"
                                                        title=" {{ $data }} users have enrolled">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <ul class="nav nav-tabs" id="tabs-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="about-tab" data-toggle="tab" href="#about" role="tab"
                                        aria-controls="about" aria-selected="true">{{ __('About me') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="classes-tab" data-toggle="tab" href="#classes" role="tab"
                                        aria-controls="classes" aria-selected="false">{{ __('My Courses') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="badges-tab" data-toggle="tab" href="#badges" role="tab"
                                        aria-controls="badges" aria-selected="false">{{ __('Badges') }}</a>
                                </li>
                            </ul>
                                            ...
                                            @if ($course_count >= 5)
                                                <div class="col-lg-4 col-6">
                                                    <div class="tab-badges-block text-center">
                                                        <img src="{{ url('images/badges/2.png') }}" class="img-fluid"
                                                            alt="">
                                                        <div class="tab-badges-heading">{{ __('Senior Instructor') }}
                                                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="instructor-img">
                        @if ($user['user_img'] != null || $user['user_img'] != '')
                            <img src="{{ asset('images/user_img/' . $user['user_img']) }}" alt="img"
                                class="img-fluid">
                        @else
                    ...
                    <div class="instructor-link">
                        <ul>
                            @if ($user->linkedin_url != null)
                                <li><a href="{{ $user->linkedin_url }}" target="_blank" title="linkedin"><i
                                            data-feather="linkedin"></i></a></li>
                            @endif
                            @if ($user->twitter_url != null)
                                <li><a href="{{ $user->twitter_url }}" target="_blank" title="twitter"><i
                                            data-feather="twitter"></i></a></li>
                            @endif
                            @if ($user->fb_url != null)
                                <li><a href="{{ $user->fb_url }}" target="_blank" title="facebook"><i
                                            data-feather="facebook"></i></a></li>
                            @endif
                            @if ($user->youtube_url != null)
                                <li><a href="{{ $user->youtube_url }}" target="_blank" title="youtube"><i
