                        ...
                        @if ($cat->status == 1)
                            <div class="item categories-tab-dtl">
                                <a href="{{ route('category.page', ['id' => $cat->id, 'category' => str_slug(str_replace('-', '&', $cat->slug))]) }}"
                                    title="tab"><i class="fa {{ $cat->icon }}"></i>{{ $cat->title }}</a>
                            </div>
                        @endif
                    @endforeach
                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="categories-block">
                                    <div class="categories-block-one">
                                        <ul>
                                            <li><a href="#" title="{{ $cat->title }}"><i
                                                        class="fa {{ $cat->icon }}"></i>
                                                </a></li>
                                            <li><a
                                                    href="{{ route('subcategory.page', ['id' => $cat->id, 'category' => str_slug(str_replace('-', '&', $cat->slug))]) }}">{{ $cat->title }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="categories-block">
                                    <ul>
                                        ...
                                        <li><a
                                                href="{{ route('childcategory.page', ['id' => $cat->id, 'category' => str_slug(str_replace('-', '&', $cat->slug))]) }}">{{ $cat->title }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <ul>
                            ...
                            @if (isset($subcat))
                                <li class="dropdown language-select dropdown-select-one">
                                    <a href="#" data-toggle="dropdown" title="Duration"
                                        class="select">{{ __('Sort') }}<i class="fa fa-chevron-down lft-7"></i></a>
                                    <ul class="dropdown-menu dropdown-menu-one">
                                        <li>
                                            <ul>
                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'a-z']) }}"
                                                        title="A-Z">A-Z {{ __('Sort') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'z-a']) }}"
                                                        title="Z-A">Z-A {{ __('Sort') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'newest']) }}"
                                                        title="{{ __('Newest') }}">{{ __('Newest') }} </a></li>
                                                <br>
                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'featured']) }}"
                                                        title="{{ __('Featured') }}">{{ __('Featured') }}</a></li>

                                                <br>
                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'l-h']) }}"
                                                        title="{{ __('Low to High') }}"> {{ __('Low to High') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'h-l']) }}"
                                                        title="{{ __('High to Low') }}"> {{ __('High to Low') }}</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown language-select dropdown-select rgt-15 limit-dropdown">
                                    <a href="#" data-toggle="dropdown" title="Ratings"
                                        class="select">{{ __('Limit') }}<i class="fa fa-chevron-down lft-7"></i></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <ul>

                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '10']) }}"
                                                        title="Highest Rated">{{ __('10') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '30']) }}"
                                                        title="Highest Rated">{{ __('30') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '50']) }}"
                                                        title="Highest Rated">{{ __('50') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('category.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '100']) }}"
                                                        title="Highest Rated">{{ __('100') }}</a></li>
                                                <br>
                            ...
                            @elseif(isset($childcat))
                                <li class="dropdown language-select dropdown-select-one">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-one">
                                        <li>
                                            <ul>
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'a-z']) }}"
                                                        title="A-Z">{{ __('A-Z') }} {{ __('Sort') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'z-a']) }}"
                                                        title="Z-A">{{ __('Z-A') }} {{ __('Sort') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'newest']) }}"
                                                        title="{{ __('Newest') }}"> {{ __('Newest') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'featured']) }}"
                                                        title="{{ __('Featured') }}">{{ __('Featured') }}</a></li>

                                                <br>
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'l-h']) }}"
                                                        title="{{ __('Low to High') }}">{{ __('Low to High') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'h-l']) }}"
                                                        title="{{ __('High to Low') }}">{{ __('High to Low') }}</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <ul>
                                                ...
                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '10']) }}"
                                                        title="Highest Rated">{{ __('10') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '30']) }}"
                                                        title="Highest Rated">{{ __('30') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '50']) }}"
                                                        title="Highest Rated">{{ __('50') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('subcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '100']) }}"
                                                        title="Highest Rated">{{ __('100') }}</a></li>
                                                <br>
                            ...
                            @else
                                <li class="dropdown language-select dropdown-select-one">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-one">
                                        <li>
                                            <ul>
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'a-z']) }}"
                                                        title="A-Z">{{ __('A-Z') }} {{ __('Sort') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'z-a']) }}"
                                                        title="Z-A">{{ __('Z-A') }} {{ __('Sort') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'newest']) }}"
                                                        title="{{ __('Newest') }}"> {{ __('Newest') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'featured']) }}"
                                                        title="{{ __('Featured') }}">{{ __('Featured') }}</a></li>

                                                <br>
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'l-h']) }}"
                                                        title="{{ __('Low to High') }}">{{ __('Low to High') }}</a></li>
                                                <br>
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'sortby' => 'h-l']) }}"
                                                        title="{{ __('High to Low') }}">{{ __('High to Low') }}</a></li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <ul>
                                                ...
                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '10']) }}"
                                                        title="Highest Rated">{{ __('10') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '30']) }}"
                                                        title="Highest Rated">{{ __('30') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '50']) }}"
                                                        title="Highest Rated">{{ __('50') }}</a></li>
                                                <br>

                                                <li><a href="{{ route('childcategory.page', ['id' => $cats->id, 'category' => str_slug(str_replace('-', '&', $cats->slug)), 'limit' => '100']) }}"
                                                        title="Highest Rated">{{ __('100') }}</a></li>
                                                <br>
                        ...
                        <div class="btn-group float-right mt-2 mb-4">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label id="list" class="btn btn-outline-dark active">
                                    <input type="radio" name="layout" id="layout1" checked> <i
                                        data-feather="list"></i>
                                </label>
                                        ...
                                        <div class="panel-group" id="accordion" role="tablist"
                                            ...
                                            @foreach ($categories->where('status', '1') as $cate)
                                                <div class="panel panel-default">
                                                    <div class="panel-heading active" role="tab" id="headingOnexxx">
                                                        <h4 class="panel-title">
                                                            <a role="button" data-toggle="collapse"
                                                                ...
                                                                href="#collapseOnexxx{{ $cate->id }}"
                                                                aria-expanded="false" aria-controls="collapseOnexxx">
                                                                <i class="fa {{ $cate->icon }} rgt-10"></i> <label
                                                                    class="prime-cat"
                                                    ...
                                                    <div id="collapseOnexxx{{ $cate->id }}"
                                                        class="subcate-collapse panel-collapse collapse in"
                                                        role="tabpanel" aria-labelledby="headingOnexxx">
                                                            ...
                                                            @if ($sub->status == 1)
                                                                <div class="panel-body">
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading" role="tab"
                                                                            ...
                                                                            <h4 class="panel-title">
                                                                                <a class="collapsed" role="button"
                                                                                    ...
                                                                                    data-parent="#accordion"
                                                                                    href="#collapseelevenxxx{{ $sub->id }}"
                                                                                    aria-expanded="false"
                                                                                    aria-controls="collapseelevenxxx">
                                                                                    <i
                                                                                        class="fa {{ $sub->icon }} rgt-10"></i>
                                                                        ...
                                                                        <div id="collapseelevenxxx{{ $sub->id }}"
                                                                            class="panel-collapse collapse"
                                                                            role="tabpanel"
                                                                            aria-labelledby="headingelevenxxx">
                                                                            @foreach ($sub->childcategory as $child)
                                                                                @if ($child->status == 1)
                                                                                    <div class="panel-body sub-cat">
                                                                                        <i
                                                                                            class="fa {{ $child->icon }} rgt-10"></i>
                                                    ...
                                                    <li>
                                                        <div class="form-check form-check-inline">
                                                            <input
                                                                ...
                                                                class="form-check-input type" type="radio"
                                                                name="type" id="flexRadioDefaultpaid" value="paid">
                                                            <label class="form-check-label active"
                                                                for="inlineCheckboxpaid">{{ __('Paid') }}</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-check form-check-inline">
                                                            <input
                                                                ...
                                                                class="form-check-input type" type="radio"
                                                                name="type" id="flexRadioDefaultfree" value="free">
                                                            <label class="form-check-label"
                                                                for="inlineCheckboxfree">{{ __('Free') }}</label>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                @foreach ($CourseLanguage as $lang)
                                                    <ul>
                                                        <li>
                                                            <div class="form-check form-check-inline">
                                                                <input
                                                                    {{ app('request')->input('lang') == $lang->id ? 'checked' : '' }}
                                                                    class="form-check-input lang" type="radio"
                                                                    name="lang"
                                                                    id="flexRadioDefault{{ $lang->id }}"
                                                                    value="{{ $lang->id }}">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox{{ $lang->id }}">{{ $lang->name }}</label>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                @endforeach
                                            ...
                                            <div class="item col-lg-12 col-12">
                                                <div class="course-bought-block protip" data-pt-placement="outside"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7 col-md-6 categories-popularity-dtl-block">
                                                            <div class="categories-popularity-dtl">
                                                                ...
                                                                <p>{{ str_limit($course->short_detail, $limit = 125, $end = '..') }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    @if ($course->type == 1)
                                                                        @if ($course->discount_price == !null)
                                                                            <li class="rate-r">
                                                                                ...
                                                                                <br><s>{{ currency($course->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</s>
                                                                            </li>
                                                                        @else
                                                    ...
                                                    @if ($course['whatlearns']->isNotEmpty())
                                                        <div id="prime-next-item-description-block{{ $course->id }}"
                                                            ...
                                                            <div class="prime-description-under-block">
                                                                <div class="prime-description-under-block">
                                                                    ...
                                                                    @foreach ($course['whatlearns'] as $wl)
                                                                        @if ($wl->status == 1)
                                                                            <div
                                                                                class="product-learn-dtl protip-whatlearn">
                                                                                <ul>
                                                                                    <li><i
