                    ...
                    <div class="genre-slide-image @if ($gsetting['course_hover'] == 1) protip @endif"
                        ...
                        <div class="view-block">
                            <div class="view-img">
                                @if ($c['preview_image'] !== null && $c['preview_image'] !== '')
                                    <a href="{{ route('user.course.show', ['id' => $c->id, 'slug' => $c->slug]) }}"><img
                                            src="{{ asset('images/course/' . $c['preview_image']) }}" alt="course"
                                            class="img-fluid">
                                    </a>
                                @else
                                    <a href="{{ route('user.course.show', ['id' => $c->id, 'slug' => $c->slug]) }}"><img
                            ...
                            <div class="view-user-img">
                                ...
                                @else
                                    <a href="{{ route('all/profile', $c->user->id) }}" title=""><img
                                            src="{{ asset('images/default/user.png') }}" class="img-fluid user-img-one"
                                            alt=""></a>
                                @endif
                            ...
                            <div class="view-dtl">
                                <div class="view-heading"><a
                                        href="{{ route('user.course.show', ['id' => $c->id, 'slug' => $c->slug]) }}">{{ str_limit($c['title'], $limit = 35, $end = '...') }}</a>
                                </div>
                                <div class="user-name">
                                                    ...
                                                    @if (Auth::User()->role == 'admin')
                                                        <div class="protip-btn">
                                                            <a href="{{ route('course.content', ['id' => $c->id, 'slug' => $c->slug]) }}"
                                                                class="btn btn-secondary" title="course">Go To
                                                                Course</a>
                                                        </div>
                                                    @else
                                                        @php
                                                    ...
                                                    <div class="protip-btn">
                                                        ...
                                                        @if ($gsetting->guest_enable == 1)
                                                            <form id="demo-form2" method="post"
                                                                ...
                                                                <div class="box-footer">
                                                                    <button type="submit"
                                                                        class="btn btn-primary shopping-cart"><i
                            ...
                            <ul>
                                ...
                                @if (Auth::check())
                                    <li class="protip-wish-btn"><a class="compare"
                                            data-id="{{ filter_var($c->id) }}" title="compare"><i
