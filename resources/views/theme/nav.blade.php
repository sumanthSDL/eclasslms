                    ...
                    <div id="notification_li">
                        ...
                        <div id="notificationContainerr">
                            ...
                            <div id="notificationFooter"><a
                                    href="{{ route('deleteNotification') }}">{{ __('ClearAll') }}</a></div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div class="panel-heading" role="tab" id="headingeleven">
                                                        <h4 class="panel-title">
                                                            <a class="collapsed" role="button"
                                                                ...
                                                                href="#collapseeleven{{ $sub->id }}"
                                                                aria-expanded="false" aria-controls="collapseeleven">
                                                                <i class="fa {{ $sub->icon }} rgt-10"></i> <label
                                                                    class="sub-cate"
                            ...
                            <li>
                                <ul>
                                    @foreach ($menus as $menu)
                                        @if ($menu->link_by == 'url')
                                            <li><a href="{{ $menu->url }}" title="Home"><i
                                                        data-feather="align-justify"></i>{{ $menu->title }}</a></li>
                                        @endif
                        ...
                        <ul>
                            ...
                            @if (Auth::User()->role == 'user' || Auth::User()->role == 'instructor')
                                @if ($gsetting->device_control == 1)
                                    <a href="{{ route('active.courses') }}" title="Watchlist">
                                        <li><i data-feather="framer"></i>{{ __('Watchlist') }}</li>
                                    </a>
                                @endif
                            @endif
                            ...
                            @if ($gsetting->donation_enable == 1)
                                <a target="__blank" href="{{ $gsetting->donation_link }}" title="Donation">
                                    <li><i data-feather="framer"></i>{{ __('Donation') }}</li>
                                </a>
                            @endif
                            ...
                            @if (Schema::hasTable('affiliate') && Schema::hasTable('wallet_settings'))
                                ...
                                @if (isset($affiliate) && $affiliate->status == 1)
                                    <a href="{{ route('get.affiliate') }}">
                                        <li><i data-feather="users"></i>{{ __('Affiliate') }}</li>
                                    </a>
                                @endif
                            @endif

                            <a href="{{ route('compare.index') }}">
                                <li><i data-feather="bar-chart"></i>{{ __('Compare') }}</li>
                            </a>
                            ...
                            @endif
                            <a href="{{ route('affilate.report') }}">
                                <li><i data-feather="users"></i>{{ __('Affiliate Dashboard') }}</li>
                            </a>
                        </ul>
                    </div>
                    <div>
                            ...
                            <div id="cssmenu">
                                <ul>
                                    <li class="mr-4"><a href="#" title="Categories"><i
                                                data-feather="grid"></i>{{ __('Categories') }}</a>
                                            ...
                                            @foreach ($categories as $cate)
                                                @if ($cate->status == 1)
                                                    <li><a href="{{ route('category.page', ['id' => $cate->id, 'category' => $cate->title]) }}"
                                                            title="{{ $cate->title }}"><i
                                                                class="fa {{ $cate->icon }} rgt-20"></i>{{ str_limit($cate->title, $limit = 25, $end = '..') }}
                                        ...
                                        <ul class="dropdown-menu">
                                            @foreach ($menus as $menu)
                                                @if ($menu->position_menu == 'top')
                                                    ...
                                                    @if ($menu->link_by == 'page')
                                                        <li><a class=""
                                                                href="{{ route('page.show', $menu->page->slug) }}">{{ $menu->title }}</a>
                                                        </li>
                                                    @endif
                                                @endif
                                            @endforeach
                                                ...
                                                <button class="btn btn-default dropdown-toggle  my-dropdown"
                                                    ...
                                                    @if (Auth::User()['user_img'] != null &&
                                                        ...
                                                        <img src="{{ url('/images/user_img/' . Auth::User()->user_img) }}"
                                                            class="circle" alt="">
                                                    @else
                                                        <img src="{{ asset('images/default/user.jpg') }}" class="circle"
                                                            alt="">
                                                    @endif
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open"
                                                    ...
                                                    <div class="scroll-down">
                                                        ...
                                                        @if ($drop->flash_deal == '1')
                                                            <a href="{{ route('flash.deals') }}">
                                                                <li><i
                                                                        data-feather="battery-charging"></i>{{ __('Flash Deals') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                        ...
                                                        @if (Auth::User()->role == 'user' || Auth::User()->role == 'instructor')
                                                            @if ($gsetting->device_control == 1)
                                                                <a href="{{ route('active.courses') }}"
                                                                    title="Watchlist">
                                                                    <li><i
                                                                            data-feather="framer"></i>{{ __('Watchlist') }}
                                                                    </li>
                                                                </a>
                                                            @endif
                                                        @endif
                                                        ...
                                                        @if ($gsetting->donation_enable == 1 && $drop->donation == '1')
                                                            <a target="__blank" href="{{ $gsetting->donation_link }}"
                                                                title="Donation">
                                                                <li><i data-feather="framer"></i>{{ __('Donation') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                        @if ($gsetting->affilate == 1 && $drop->my_wallet == '1')
                                                            ...
                                                            @if (isset($affiliate) && $affiliate->status == 1)
                                                                <a href="{{ route('get.affiliate') }}">
                                                                    <li><i data-feather="users"></i>{{ __('Affiliate') }}
                                                                    </li>
                                                                </a>
                                                            @endif
                                                        @endif
                                                        @if ($drop->compare == '1')
                                                            <a href="{{ route('compare.index') }}">
                                                                <li><i data-feather="bar-chart"></i>{{ __('Compare') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                        ...
                                                        @if ($drop->affilate_dashboard == '1')
                                                            <a href="{{ route('affilate.report') }}">
                                                                <li><i
                                                                        data-feather="users"></i>{{ __('Affiliate Dashboard') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                        <a href="{{ route('batch.front') }}">
                                                            <li><i data-feather="book-open"></i>Batch</li>
                                                        </a>
                                                    </div>
                                                    @if (Module::has('Ebook') && Module::find('Ebook')->isEnabled())
                                                        <a href="{{ route('web.ebook.confirm-order') }}">
                                                            <li><i data-feather="book-open"></i>{{ __('My Ebook') }}</li>
                                                        </a>
                                                    @endif
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open"
                                                ...
                                                <div class="scroll-down">
                                                    ...
                                                    @if (Auth::User()->role == 'user' || Auth::User()->role == 'instructor')
                                                        @if ($gsetting->device_control == 1)
                                                            <a href="{{ route('active.courses') }}" title="Watchlist">
                                                                <li><i data-feather="framer"></i>{{ __('Watchlist') }}
                                                                </li>
                                                            </a>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @endif
                                                    <a href="{{ route('affilate.report') }}">
                                                        <li><i data-feather="users"></i>{{ __('Affiliate Dashboard') }}
                                                        </li>
                                                    </a>
                                                    <a href="{{ route('batch.front') }}">
                                                        <li><i data-feather="book-open"></i>{{ __('Batch') }}</li>
                                                    </a>
                                                    @if (Module::has('Ebook') && Module::find('Ebook')->isEnabled())
                                                        <a href="{{ route('web.ebook.confirm-order') }}">
                                                            <li><i data-feather="book-open"></i>{{ __('My Ebook') }}</li>
...
<div id="find" class="small-screen-navigation">
    ...
    <form action="{{ route('search') }}" class="form-inline search-form" method="GET">
        <input type="find" name="searchTerm" class="form-control" id="search"
            placeholder="{{ __('Searchforcourses') }}" value="{{ isset($searchTerm) ? $searchTerm : '' }}">
